...
# Backup & Disaster Recovery - AI Agent Configuration
...
Ask Amani is SARAISE's conversational AI assistant that can interact with all modules. This section documents how Ask Amani works with the Backup & Disaster Recovery module.
...
agent:
  name: "backup-disaster-recovery-assistant"
  type: "support"
  module: "backup-disaster-recovery"
  autonomy_level: 2
  triggers:
...
agent:
  name: "backup-disaster-recovery-advanced"
  type: "technical"
  module: "backup-disaster-recovery"
  autonomy_level: 4
  triggers:
