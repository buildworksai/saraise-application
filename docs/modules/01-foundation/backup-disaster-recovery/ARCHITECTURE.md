...
**Merged from:** Backup-Disaster-Recovery-DESIGN.md and Backup-Disaster-Recovery-DESIGN-PART2.md
...
- [API Specification](#api-specification)
  - [Endpoints Overview](#endpoints-overview)
    - [GET /api/v1/backup-disaster-recovery/[resource]](#get-apiv1backup-disaster-recoveryresource)
