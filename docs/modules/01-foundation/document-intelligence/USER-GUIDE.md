...
This guide provides instructions for using the Document Intelligence module.
...
<!-- SPDX-License-Identifier: Apache-2.0 -->
# Document Intelligence - Customization Guide
...
This guide explains how to customize the Document Intelligence module to meet your specific business requirements using SARAISE's low-code customization features.

## Customization Options

The Document Intelligence module supports extensive customization through:
...
### Common Custom Fields for Document Intelligence
...
# hooks.py
hooks = {
    "document-intelligence.[Resource Type].before_save": "document-intelligence.customizations.[resource_type].before_save"
}
```
...
#### Endpoint: [Name]
**Path:** `/api/v1/document-intelligence/[path]`
**Method:** POST
...
- Prefix custom fields with module name: `document-intelligence_custom_field`
...
<!-- SPDX-License-Identifier: Apache-2.0 -->
# Document Intelligence - Integration Guide
...
This document describes all integration points for the Document Intelligence module, including internal module integrations, external system integrations, and webhook events.

---

## Integration Overview

The Document Intelligence module integrates with:
...
|-------|----------|---------|----------|
| [event.name] | `/api/v1/document-intelligence/webhooks/[path]` | [Handler function] | [Use case] |
...
<!-- SPDX-License-Identifier: Apache-2.0 -->
# Document Intelligence - Demo Data
...
This document describes the comprehensive demo data included with the Document Intelligence module for testing and training purposes.

## Overview

The demo data seed script (`backend/scripts/seed_document-intelligence_demo.py`) creates a fully functional Document Intelligence setup for the demo tenant `demo@saraise.com` with:
...
**Usage:**
```bash
python backend/scripts/seed_document-intelligence_demo.py --size basic
```
...
**Usage:**
```bash
python backend/scripts/seed_document-intelligence_demo.py --size full
```
...
**File:** `backend/scripts/seed_document-intelligence_demo.py`

**Usage:**
```bash
# Basic demo
python backend/scripts/seed_document-intelligence_demo.py --size basic --tenant demo@saraise.com

# Full demo
python backend/scripts/seed_document-intelligence_demo.py --size full --tenant demo@saraise.com

# Custom count
python backend/scripts/seed_document-intelligence_demo.py --count 50 --tenant demo@saraise.com
```
...
#### `generate_document-intelligence_data(count)`
**Purpose:** Generate [entity type] records
**Parameters:**
- `count` (int): Number of records to generate

```python
def generate_document-intelligence_data(count: int):
    """Generate demo data"""
    # Implementation
    pass
```
...
```bash
python backend/scripts/seed_document-intelligence_demo.py --reset --tenant demo@saraise.com
```
...
3. **Run:**
```bash
python backend/scripts/seed_document-intelligence_demo.py --custom
```
