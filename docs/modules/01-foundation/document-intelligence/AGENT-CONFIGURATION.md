...
# Document Intelligence - AI Agent Configuration
...
Ask Amani is SARAISE's conversational AI assistant that can interact with all modules. This section documents how Ask Amani works with the Document Intelligence module.
...
agent:
  name: "document-intelligence-advanced"
  type: "technical"
  module: "document-intelligence"
  autonomy_level: 4
  triggers:
