...
**Merged from:** Document-Intelligence-DESIGN.md and Document-Intelligence-DESIGN-PART2.md
...
- [API Specification](#api-specification)
  - [Endpoints Overview](#endpoints-overview)
    - [GET /api/v1/document-intelligence/[resource]](#get-apiv1document-intelligenceresource)
...
|--------|----------|-------------|------|
| GET | `/api/v1/document-intelligence/[resource]` | [Description] | Required |
| POST | `/api/v1/document-intelligence/[resource]` | [Description] | Required |
| PUT | `/api/v1/document-intelligence/[resource]/{id}` | [Description] | Required |
| DELETE | `/api/v1/document-intelligence/[resource]/{id}` | [Description] | Required |

#### GET /api/v1/document-intelligence/[resource]
