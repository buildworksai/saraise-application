...
This guide provides instructions for using the Tenant Management module.
...
**Description**: Tenant quota usage tracking (Django ORM model)
...
### 5. TenantActivitySnapshot Model
...
### 7. TenantChurnRiskSnapshot Model
