...
This guide provides instructions for using the Integration Platform module.
...
<!-- SPDX-License-Identifier: Apache-2.0 -->
# Integration Platform (iPaaS) - Customization Guide
...
This guide explains how to customize the Integration Platform (iPaaS) module to meet your specific business requirements using SARAISE's low-code customization features.

## Customization Options

The Integration Platform (iPaaS) module supports extensive customization through:
...
### Common Custom Fields for Integration Platform (iPaaS)
...
# hooks.py
hooks = {
    "integration-platform.[Resource Type].before_save": "integration-platform.customizations.[resource_type].before_save"
}
```
...
#### Endpoint: [Name]
**Path:** `/api/v1/integration-platform/[path]`
**Method:** POST
...
- Prefix custom fields with module name: `integration-platform_custom_field`
...
<!-- SPDX-License-Identifier: Apache-2.0 -->
# Integration Platform (iPaaS) - Integration Guide
...
This document describes all integration points for the Integration Platform (iPaaS) module, including internal module integrations, external system integrations, and webhook events.

---

## Integration Overview

The Integration Platform (iPaaS) module integrates with:
...
|-------|----------|---------|----------|
| [event.name] | `/api/v1/integration-platform/webhooks/[path]` | [Handler function] | [Use case] |
...
<!-- SPDX-License-Identifier: Apache-2.0 -->
# Integration Platform (iPaaS) - Demo Data
...
This document describes the comprehensive demo data included with the Integration Platform (iPaaS) module for testing and training purposes.

## Overview

The demo data seed script (`backend/scripts/seed_integration-platform_demo.py`) creates a fully functional Integration Platform (iPaaS) setup for the demo tenant `demo@saraise.com` with:
...
**Usage:**
```bash
python backend/scripts/seed_integration-platform_demo.py --size basic
```
...
**Usage:**
```bash
python backend/scripts/seed_integration-platform_demo.py --size full
```
...
**File:** `backend/scripts/seed_integration-platform_demo.py`

**Usage:**
```bash
# Basic demo
python backend/scripts/seed_integration-platform_demo.py --size basic --tenant demo@saraise.com

# Full demo
python backend/scripts/seed_integration-platform_demo.py --size full --tenant demo@saraise.com

# Custom count
python backend/scripts/seed_integration-platform_demo.py --count 50 --tenant demo@saraise.com
```
...
#### `generate_integration-platform_data(count)`
**Purpose:** Generate [entity type] records
**Parameters:**
- `count` (int): Number of records to generate

```python
def generate_integration-platform_data(count: int):
    """Generate demo data"""
    # Implementation
    pass
```
...
```bash
python backend/scripts/seed_integration-platform_demo.py --reset --tenant demo@saraise.com
```
...
3. **Run:**
```bash
python backend/scripts/seed_integration-platform_demo.py --custom
```
