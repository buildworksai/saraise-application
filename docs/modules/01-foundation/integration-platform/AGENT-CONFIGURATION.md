...
# Integration Platform (iPaaS) - AI Agent Configuration
...
Ask Amani is SARAISE's conversational AI assistant that can interact with all modules. This section documents how Ask Amani works with the Integration Platform (iPaaS) module.
...
agent:
  name: "integration-platform-assistant"
  type: "support"
  module: "integration-platform"
  autonomy_level: 2
  triggers:
