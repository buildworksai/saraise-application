...
This guide provides instructions for using the Performance Monitoring module.
...
<!-- SPDX-License-Identifier: Apache-2.0 -->
# Performance Monitoring - Customization Guide
...
This guide explains how to customize the Performance Monitoring module to meet your specific business requirements using SARAISE's low-code customization features.

## Customization Options

The Performance Monitoring module supports extensive customization through:
...
### Common Custom Fields for Performance Monitoring
...
# hooks.py
hooks = {
    "performance-monitoring.[Resource Type].before_save": "performance-monitoring.customizations.[resource_type].before_save"
}
```
...
#### Endpoint: [Name]
**Path:** `/api/v1/performance-monitoring/[path]`
**Method:** POST
...
- Prefix custom fields with module name: `performance-monitoring_custom_field`
...
This document describes all integration points for the Performance Monitoring module, including internal module integrations, external system integrations, and webhook events.

---

## Integration Overview

The Performance Monitoring module integrates with:
...
|-------|----------|---------|----------|
| [event.name] | `/api/v1/performance-monitoring/webhooks/[path]` | [Handler function] | [Use case] |
...
<!-- SPDX-License-Identifier: Apache-2.0 -->
# Performance Monitoring - Demo Data
...
This document describes the comprehensive demo data included with the Performance Monitoring module for testing and training purposes.

## Overview

The demo data seed script (`backend/scripts/seed_performance-monitoring_demo.py`) creates a fully functional Performance Monitoring setup for the demo tenant `demo@saraise.com` with:
...
**Usage:**
```bash
python backend/scripts/seed_performance-monitoring_demo.py --size basic
```
...
**Usage:**
```bash
python backend/scripts/seed_performance-monitoring_demo.py --size full
```
...
**File:** `backend/scripts/seed_performance-monitoring_demo.py`

**Usage:**
```bash
# Basic demo
python backend/scripts/seed_performance-monitoring_demo.py --size basic --tenant demo@saraise.com

# Full demo
python backend/scripts/seed_performance-monitoring_demo.py --size full --tenant demo@saraise.com

# Custom count
python backend/scripts/seed_performance-monitoring_demo.py --count 50 --tenant demo@saraise.com
```
...
#### `generate_performance-monitoring_data(count)`
**Purpose:** Generate [entity type] records
**Parameters:**
- `count` (int): Number of records to generate

```python
def generate_performance-monitoring_data(count: int):
    """Generate demo data"""
    # Implementation
    pass
```
...
```bash
python backend/scripts/seed_performance-monitoring_demo.py --reset --tenant demo@saraise.com
```
...
3. **Run:**
```bash
python backend/scripts/seed_performance-monitoring_demo.py --custom
```
