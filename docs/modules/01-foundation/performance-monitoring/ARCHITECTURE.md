...
**Merged from:** Performance-Monitoring-DESIGN.md and Performance-Monitoring-DESIGN-PART2.md
...
- [API Specification](#api-specification)
  - [Endpoints Overview](#endpoints-overview)
    - [GET /api/v1/performance-monitoring/[resource]](#get-apiv1performance-monitoringresource)
