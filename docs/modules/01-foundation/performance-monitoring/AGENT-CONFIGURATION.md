...
# Performance Monitoring - AI Agent Configuration
...
Ask Amani is SARAISE's conversational AI assistant that can interact with all modules. This section documents how Ask Amani works with the Performance Monitoring module.
...
agent:
  name: "performance-monitoring-assistant"
  type: "support"
  module: "performance-monitoring"
  autonomy_level: 2
  triggers:
...
agent:
  name: "performance-monitoring-advanced"
  type: "technical"
  module: "performance-monitoring"
  autonomy_level: 4
  triggers:
