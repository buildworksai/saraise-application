...
# AI Provider Configuration - AI Agent Configuration
...
Ask Amani is SARAISE's conversational AI assistant that can interact with all modules. This section documents how Ask Amani works with the AI Provider Configuration module.
...
agent:
  name: "ai-provider-configuration-assistant"
  type: "support"
  module: "ai-provider-configuration"
  autonomy_level: 2
  triggers:
...
agent:
  name: "ai-provider-configuration-advanced"
  type: "technical"
  module: "ai-provider-configuration"
  autonomy_level: 4
  triggers:
