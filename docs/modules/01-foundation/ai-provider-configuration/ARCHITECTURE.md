...
**Merged from:** Ai-Provider-Configuration-DESIGN.md and Ai-Provider-Configuration-DESIGN-PART2.md
...
- [API Specification](#api-specification)
  - [Endpoints Overview](#endpoints-overview)
    - [GET /api/v1/ai-provider-configuration/[resource]](#get-apiv1ai-provider-configurationresource)
...
|--------|----------|-------------|------|
| GET | `/api/v1/ai-provider-configuration/[resource]` | [Description] | Required |
| POST | `/api/v1/ai-provider-configuration/[resource]` | [Description] | Required |
| PUT | `/api/v1/ai-provider-configuration/[resource]/{id}` | [Description] | Required |
| DELETE | `/api/v1/ai-provider-configuration/[resource]/{id}` | [Description] | Required |

#### GET /api/v1/ai-provider-configuration/[resource]
