...
# Workflow Automation Frontend - Customization Guide
...
This guide explains how to customize the Workflow Automation Frontend module to meet your specific business requirements using SARAISE's low-code customization features.

## Customization Options

The Workflow Automation Frontend module supports extensive customization through:
...
### Common Custom Fields for Workflow Automation Frontend
...
# hooks.py
hooks = {
    "workflow-automation.[Resource Type].before_save": "workflow-automation.customizations.[resource_type].before_save"
}
```
...
#### Endpoint: [Name]
**Path:** `/api/v1/workflow-automation/[path]`
**Method:** POST
...
- Prefix custom fields with module name: `workflow-automation_custom_field`
