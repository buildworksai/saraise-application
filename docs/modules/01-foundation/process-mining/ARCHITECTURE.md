...
**Merged from:** Process-Mining-DESIGN.md and Process-Mining-DESIGN-PART2.md
...
- [API Specification](#api-specification)
  - [Endpoints Overview](#endpoints-overview)
    - [GET /api/v1/process-mining/[resource]](#get-apiv1process-miningresource)
...
|--------|----------|-------------|------|
| GET | `/api/v1/process-mining/[resource]` | [Description] | Required |
| POST | `/api/v1/process-mining/[resource]` | [Description] | Required |
| PUT | `/api/v1/process-mining/[resource]/{id}` | [Description] | Required |
| DELETE | `/api/v1/process-mining/[resource]/{id}` | [Description] | Required |

#### GET /api/v1/process-mining/[resource]
