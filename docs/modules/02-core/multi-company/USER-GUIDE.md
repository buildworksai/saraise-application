...
This guide provides instructions for using the Multi Company module.
...
<!-- SPDX-License-Identifier: Apache-2.0 -->
# Multi-Company Management - Customization Guide
...
This guide explains how to customize the Multi-Company Management module to meet your specific business requirements using SARAISE's low-code customization features.

## Customization Options

The Multi-Company Management module supports extensive customization through:
...
### Common Custom Fields for Multi-Company Management
...
# hooks.py
hooks = {
    "multi-company.[Resource Type].before_save": "multi-company.customizations.[resource_type].before_save"
}
```
...
#### Endpoint: [Name]
**Path:** `/api/v1/multi-company/[path]`
**Method:** POST
...
- Prefix custom fields with module name: `multi-company_custom_field`
...
<!-- SPDX-License-Identifier: Apache-2.0 -->
# Multi-Company Management - Integration Guide
...
This document describes all integration points for the Multi-Company Management module, including internal module integrations, external system integrations, and webhook events.

---

## Integration Overview

The Multi-Company Management module integrates with:
...
|-------|----------|---------|----------|
| [event.name] | `/api/v1/multi-company/webhooks/[path]` | [Handler function] | [Use case] |
...
<!-- SPDX-License-Identifier: Apache-2.0 -->
# Multi-Company Management - Demo Data
...
This document describes the comprehensive demo data included with the Multi-Company Management module for testing and training purposes.

## Overview

The demo data seed script (`backend/scripts/seed_multi-company_demo.py`) creates a fully functional Multi-Company Management setup for the demo tenant `demo@saraise.com` with:
...
**Usage:**
```bash
python backend/scripts/seed_multi-company_demo.py --size basic
```
...
**Usage:**
```bash
python backend/scripts/seed_multi-company_demo.py --size full
```
...
**File:** `backend/scripts/seed_multi-company_demo.py`

**Usage:**
```bash
# Basic demo
python backend/scripts/seed_multi-company_demo.py --size basic --tenant demo@saraise.com

# Full demo
python backend/scripts/seed_multi-company_demo.py --size full --tenant demo@saraise.com

# Custom count
python backend/scripts/seed_multi-company_demo.py --count 50 --tenant demo@saraise.com
```
...
```bash
python backend/scripts/seed_multi-company_demo.py --reset --tenant demo@saraise.com
```
...
3. **Run:**
```bash
python backend/scripts/seed_multi-company_demo.py --custom
```
