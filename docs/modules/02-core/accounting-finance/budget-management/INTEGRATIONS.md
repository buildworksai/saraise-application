...
# Budget Management - Integration Guide
...
This document describes all integration points for the Budget Management module, including internal module integrations, external system integrations, and webhook events.

---

## Integration Overview

The Budget Management module integrates with:
...
|-------|----------|---------|----------|
| [event.name] | `/api/v1/budget-management/webhooks/[path]` | [Handler function] | [Use case] |
