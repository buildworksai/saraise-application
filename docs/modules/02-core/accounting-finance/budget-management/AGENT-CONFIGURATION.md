...
# Budget Management - AI Agent Configuration
...
Ask Amani is SARAISE's conversational AI assistant that can interact with all modules. This section documents how Ask Amani works with the Budget Management module.
...
agent:
  name: "budget-management-advanced"
  type: "technical"
  module: "budget-management"
  autonomy_level: 4
  triggers:
