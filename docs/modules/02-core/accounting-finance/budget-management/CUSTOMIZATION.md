...
# Budget Management - Customization Guide
...
This guide explains how to customize the Budget Management module to meet your specific business requirements using SARAISE's low-code customization features.

## Customization Options

The Budget Management module supports extensive customization through:
...
### Common Custom Fields for Budget Management
...
# hooks.py
hooks = {
    "budget-management.[Resource Type].before_save": "budget-management.customizations.[resource_type].before_save"
}
```
...
#### Endpoint: [Name]
**Path:** `/api/v1/budget-management/[path]`
**Method:** POST
...
- Prefix custom fields with module name: `budget-management_custom_field`
