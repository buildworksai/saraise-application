...
# Bank Statement Import - AI Agent Configuration
...
Ask Amani is SARAISE's conversational AI assistant that can interact with all modules. This section documents how Ask Amani works with the Bank Statement Import module.
...
agent:
  name: "bank-reconciliation-advanced"
  type: "technical"
  module: "bank-reconciliation"
  autonomy_level: 4
  triggers:
