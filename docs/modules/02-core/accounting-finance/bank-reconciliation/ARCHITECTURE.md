...
**Merged from:** Bank-Reconciliation-DESIGN.md and Bank-Reconciliation-DESIGN-PART2.md
...
- [API Specification](#api-specification)
  - [Endpoints Overview](#endpoints-overview)
    - [GET /api/v1/bank-reconciliation/[resource]](#get-apiv1bank-reconciliationresource)
...
|--------|----------|-------------|------|
| GET | `/api/v1/bank-reconciliation/[resource]` | [Description] | Required |
| POST | `/api/v1/bank-reconciliation/[resource]` | [Description] | Required |
| PUT | `/api/v1/bank-reconciliation/[resource]/{id}` | [Description] | Required |
| DELETE | `/api/v1/bank-reconciliation/[resource]/{id}` | [Description] | Required |

#### GET /api/v1/bank-reconciliation/[resource]
