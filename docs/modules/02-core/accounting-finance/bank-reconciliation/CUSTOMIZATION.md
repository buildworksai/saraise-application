...
# Bank Statement Import - Customization Guide
...
This guide explains how to customize the Bank Statement Import module to meet your specific business requirements using SARAISE's low-code customization features.

## Customization Options

The Bank Statement Import module supports extensive customization through:
...
### Common Custom Fields for Bank Statement Import
...
# hooks.py
hooks = {
    "bank-reconciliation.[Resource Type].before_save": "bank-reconciliation.customizations.[resource_type].before_save"
}
```
...
#### Endpoint: [Name]
**Path:** `/api/v1/bank-reconciliation/[path]`
**Method:** POST
...
- Prefix custom fields with module name: `bank-reconciliation_custom_field`
