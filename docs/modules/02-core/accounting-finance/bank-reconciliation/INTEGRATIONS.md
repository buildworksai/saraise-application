...
# Bank Statement Import - Integration Guide
...
This document describes all integration points for the Bank Statement Import module, including internal module integrations, external system integrations, and webhook events.

---

## Integration Overview

The Bank Statement Import module integrates with:
...
|-------|----------|---------|----------|
| [event.name] | `/api/v1/bank-reconciliation/webhooks/[path]` | [Handler function] | [Use case] |
