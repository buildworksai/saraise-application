...
# Bank Statement Import - Demo Data

**Version:** 1.0.0
**Last Updated:** 2025-12-01
**Status:** Demo Data Reference
**Development Agent:** Agent 83

---

This document describes the comprehensive demo data included with the Bank Statement Import module for testing and training purposes.

## Overview

The demo data seed script (`backend/scripts/seed_bank-reconciliation_demo.py`) creates a fully functional Bank Statement Import setup for the demo tenant `demo@saraise.com` with:
...
**Usage:**
```bash
python backend/scripts/seed_bank-reconciliation_demo.py --size basic
```
...
**Usage:**
```bash
python backend/scripts/seed_bank-reconciliation_demo.py --size full
```
...
**File:** `backend/scripts/seed_bank-reconciliation_demo.py`

**Usage:**
```bash
# Basic demo
python backend/scripts/seed_bank-reconciliation_demo.py --size basic --tenant demo@saraise.com

# Full demo
python backend/scripts/seed_bank-reconciliation_demo.py --size full --tenant demo@saraise.com

# Custom count
python backend/scripts/seed_bank-reconciliation_demo.py --count 50 --tenant demo@saraise.com
```
...
#### `generate_bank-reconciliation_data(count)`
**Purpose:** Generate [entity type] records
**Parameters:**
- `count` (int): Number of records to generate

```python
def generate_bank-reconciliation_data(count: int):
    """Generate demo data"""
    # Implementation
    pass
```
...
```bash
python backend/scripts/seed_bank-reconciliation_demo.py --reset --tenant demo@saraise.com
```
...
3. **Run:**
```bash
python backend/scripts/seed_bank-reconciliation_demo.py --custom
```
