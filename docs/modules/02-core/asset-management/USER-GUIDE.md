...
This guide provides instructions for using the Asset Management module.
...
<!-- SPDX-License-Identifier: Apache-2.0 -->
# Fixed Asset Management - Customization Guide
...
This guide explains how to customize the Fixed Asset Management module to meet your specific business requirements using SARAISE's low-code customization features.

## Customization Options

The Fixed Asset Management module supports extensive customization through:
...
### Common Custom Fields for Fixed Asset Management
...
# hooks.py
hooks = {
    "asset-management.[Resource Type].before_save": "asset-management.customizations.[resource_type].before_save"
}
```
...
#### Endpoint: [Name]
**Path:** `/api/v1/asset-management/[path]`
**Method:** POST
...
- Prefix custom fields with module name: `asset-management_custom_field`
...
<!-- SPDX-License-Identifier: Apache-2.0 -->
# Fixed Asset Management - Demo Data
...
This document describes the comprehensive demo data included with the Fixed Asset Management module for testing and training purposes.

## Overview

The demo data seed script (`backend/scripts/seed_asset-management_demo.py`) creates a fully functional Fixed Asset Management setup for the demo tenant `demo@saraise.com` with:
...
**Usage:**
```bash
python backend/scripts/seed_asset-management_demo.py --size basic
```
...
**Usage:**
```bash
python backend/scripts/seed_asset-management_demo.py --size full
```
...
**File:** `backend/scripts/seed_asset-management_demo.py`

**Usage:**
```bash
# Basic demo
python backend/scripts/seed_asset-management_demo.py --size basic --tenant demo@saraise.com

# Full demo
python backend/scripts/seed_asset-management_demo.py --size full --tenant demo@saraise.com

# Custom count
python backend/scripts/seed_asset-management_demo.py --count 50 --tenant demo@saraise.com
```
...
#### `generate_asset-management_data(count)`
**Purpose:** Generate [entity type] records
**Parameters:**
- `count` (int): Number of records to generate

```python
def generate_asset-management_data(count: int):
    """Generate demo data"""
    # Implementation
    pass
```
...
```bash
python backend/scripts/seed_asset-management_demo.py --reset --tenant demo@saraise.com
```
...
3. **Run:**
```bash
python backend/scripts/seed_asset-management_demo.py --custom
```
