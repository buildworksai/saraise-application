...
This guide provides instructions for using the Business Intelligence module.
...
<!-- SPDX-License-Identifier: Apache-2.0 -->
# Business Intelligence - Customization Guide
...
This guide explains how to customize the Business Intelligence module to meet your specific business requirements using SARAISE's low-code customization features.

## Customization Options

The Business Intelligence module supports extensive customization through:
...
### Common Custom Fields for Business Intelligence
...
# hooks.py
hooks = {
    "business-intelligence.[Resource Type].before_save": "business-intelligence.customizations.[resource_type].before_save"
}
```
...
#### Endpoint: [Name]
**Path:** `/api/v1/business-intelligence/[path]`
**Method:** POST
...
- Prefix custom fields with module name: `business-intelligence_custom_field`
...
This document describes all integration points for the Business Intelligence module, including internal module integrations, external system integrations, and webhook events.

---

## Integration Overview

The Business Intelligence module integrates with:
...
|-------|----------|---------|----------|
| [event.name] | `/api/v1/business-intelligence/webhooks/[path]` | [Handler function] | [Use case] |
...
This document describes the comprehensive demo data included with the Business Intelligence module for testing and training purposes.

## Overview

The demo data seed script (`backend/scripts/seed_business-intelligence_demo.py`) creates a fully functional Business Intelligence setup for the demo tenant `demo@saraise.com` with:
...
**Usage:**
```bash
python backend/scripts/seed_business-intelligence_demo.py --size basic
```
...
**Usage:**
```bash
python backend/scripts/seed_business-intelligence_demo.py --size full
```
...
**File:** `backend/scripts/seed_business-intelligence_demo.py`

**Usage:**
```bash
# Basic demo
python backend/scripts/seed_business-intelligence_demo.py --size basic --tenant demo@saraise.com

# Full demo
python backend/scripts/seed_business-intelligence_demo.py --size full --tenant demo@saraise.com

# Custom count
python backend/scripts/seed_business-intelligence_demo.py --count 50 --tenant demo@saraise.com
```
...
#### `generate_business-intelligence_data(count)`
**Purpose:** Generate [entity type] records
**Parameters:**
- `count` (int): Number of records to generate

```python
def generate_business-intelligence_data(count: int):
    """Generate demo data"""
    # Implementation
    pass
```
...
```bash
python backend/scripts/seed_business-intelligence_demo.py --reset --tenant demo@saraise.com
```
...
3. **Run:**
```bash
python backend/scripts/seed_business-intelligence_demo.py --custom
```
