...
# Purchase & Procurement - Customization Guide
...
This guide explains how to customize the Purchase & Procurement module to meet your specific business requirements using SARAISE's low-code customization features.

## Customization Options

The Purchase & Procurement module supports extensive customization through:
...
### Common Custom Fields for Purchase & Procurement
...
# hooks.py
hooks = {
    "purchase-management.[Resource Type].before_save": "purchase-management.customizations.[resource_type].before_save"
}
```
...
#### Endpoint: [Name]
**Path:** `/api/v1/purchase-management/[path]`
**Method:** POST
...
- Prefix custom fields with module name: `purchase-management_custom_field`
