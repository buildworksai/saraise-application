...
# Purchase & Procurement - Demo Data
...
This document describes the comprehensive demo data included with the Purchase & Procurement module for testing and training purposes.

## Overview

The demo data seed script (`backend/scripts/seed_purchase-management_demo.py`) creates a fully functional Purchase & Procurement setup for the demo tenant `demo@saraise.com` with:
...
**Usage:**
```bash
python backend/scripts/seed_purchase-management_demo.py --size basic
```
...
**Usage:**
```bash
python backend/scripts/seed_purchase-management_demo.py --size full
```
...
**File:** `backend/scripts/seed_purchase-management_demo.py`

**Usage:**
```bash
# Basic demo
python backend/scripts/seed_purchase-management_demo.py --size basic --tenant demo@saraise.com

# Full demo
python backend/scripts/seed_purchase-management_demo.py --size full --tenant demo@saraise.com

# Custom count
python backend/scripts/seed_purchase-management_demo.py --count 50 --tenant demo@saraise.com
```
...
#### `generate_purchase-management_data(count)`
**Purpose:** Generate [entity type] records
**Parameters:**
- `count` (int): Number of records to generate

```python
def generate_purchase-management_data(count: int):
    """Generate demo data"""
    # Implementation
    pass
```
...
```bash
python backend/scripts/seed_purchase-management_demo.py --reset --tenant demo@saraise.com
```
...
3. **Run:**
```bash
python backend/scripts/seed_purchase-management_demo.py --custom
```
