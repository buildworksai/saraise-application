...
# Communication Hub - AI Agent Configuration
...
Ask Amani is SARAISE's conversational AI assistant that can interact with all modules. This section documents how Ask Amani works with the Communication Hub module.
...
agent:
  name: "communication-hub-assistant"
  type: "support"
  module: "communication-hub"
  autonomy_level: 2
  triggers:
...
agent:
  name: "communication-hub-advanced"
  type: "technical"
  module: "communication-hub"
  autonomy_level: 4
  triggers:
