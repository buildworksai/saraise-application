...
**Merged from:** Communication-Hub-DESIGN.md and Communication-Hub-DESIGN-PART2.md
...
- [API Specification](#api-specification)
  - [Endpoints Overview](#endpoints-overview)
    - [GET /api/v1/communication-hub/[resource]](#get-apiv1communication-hubresource)
...
|--------|----------|-------------|------|
| GET | `/api/v1/communication-hub/[resource]` | [Description] | Required |
| POST | `/api/v1/communication-hub/[resource]` | [Description] | Required |
| PUT | `/api/v1/communication-hub/[resource]/{id}` | [Description] | Required |
| DELETE | `/api/v1/communication-hub/[resource]/{id}` | [Description] | Required |

#### GET /api/v1/communication-hub/[resource]
