...
This guide provides instructions for using the Sales Management module.
...
<!-- SPDX-License-Identifier: Apache-2.0 -->
# Sales Management - Integration Guide
...
This document describes all integration points for the Sales Management module, including internal module integrations, external system integrations, and webhook events.

---

## Integration Overview

The Sales Management module integrates with:
...
|-------|----------|---------|----------|
| [event.name] | `/api/v1/sales-management/webhooks/[path]` | [Handler function] | [Use case] |
...
This document describes the comprehensive demo data included with the Sales Management module for testing and training purposes.

## Overview

The demo data seed script (`backend/scripts/seed_sales-management_demo.py`) creates a fully functional Sales Management setup for the demo tenant `demo@saraise.com` with:
...
**Usage:**
```bash
python backend/scripts/seed_sales-management_demo.py --size basic
```
...
**Usage:**
```bash
python backend/scripts/seed_sales-management_demo.py --size full
```
...
**File:** `backend/scripts/seed_sales-management_demo.py`

**Usage:**
```bash
# Basic demo
python backend/scripts/seed_sales-management_demo.py --size basic --tenant demo@saraise.com

# Full demo
python backend/scripts/seed_sales-management_demo.py --size full --tenant demo@saraise.com

# Custom count
python backend/scripts/seed_sales-management_demo.py --count 50 --tenant demo@saraise.com
```
...
#### `generate_sales-management_data(count)`
**Purpose:** Generate [entity type] records
**Parameters:**
- `count` (int): Number of records to generate

```python
def generate_sales-management_data(count: int):
    """Generate demo data"""
    # Implementation
    pass
```
...
```bash
python backend/scripts/seed_sales-management_demo.py --reset --tenant demo@saraise.com
```
...
3. **Run:**
```bash
python backend/scripts/seed_sales-management_demo.py --custom
```
