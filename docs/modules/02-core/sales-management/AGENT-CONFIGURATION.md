...
# Sales Management - AI Agent Configuration
...
Ask Amani is SARAISE's conversational AI assistant that can interact with all modules. This section documents how Ask Amani works with the Sales Management module.
...
agent:
  name: "sales-management-assistant"
  type: "support"
  module: "sales-management"
  autonomy_level: 2
  triggers:
...
agent:
  name: "sales-management-advanced"
  type: "technical"
  module: "sales-management"
  autonomy_level: 4
  triggers:
