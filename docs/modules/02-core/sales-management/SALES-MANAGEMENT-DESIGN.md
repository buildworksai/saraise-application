...
# Sales Management - Comprehensive Design Document
...
|--------|----------|-------------|------|
| GET | `/api/v1/sales-management/[resource]` | [Description] | Required |
| POST | `/api/v1/sales-management/[resource]` | [Description] | Required |
| PUT | `/api/v1/sales-management/[resource]/{id}` | [Description] | Required |
| DELETE | `/api/v1/sales-management/[resource]/{id}` | [Description] | Required |

#### GET /api/v1/sales-management/[resource]
