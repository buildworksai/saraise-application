...
This guide provides instructions for using the Dms module.
...
<!-- SPDX-License-Identifier: Apache-2.0 -->
# Document Management System - Customization Guide

**Version:** 1.0.0
**Last Updated:** 2025-12-01
**Status:** Customization Reference
**Development Agent:** Agent 85

---

This guide explains how to customize the Document Management System module to meet your specific business requirements using SARAISE's low-code customization features.

## Customization Options

The Document Management System module supports extensive customization through:
...
### Common Custom Fields for Document Management System
...
# hooks.py
hooks = {
    "dms.[Resource Type].before_save": "dms.customizations.[resource_type].before_save"
}
```
...
- Prefix custom fields with module name: `dms_custom_field`
...
This document describes all integration points for the Document Management System module, including internal module integrations, external system integrations, and webhook events.

---

## Integration Overview

The Document Management System module integrates with:
...
|-------|----------|---------|----------|
| [event.name] | `/api/v1/dms/webhooks/[path]` | [Handler function] | [Use case] |
...
<!-- SPDX-License-Identifier: Apache-2.0 -->
# Document Management System - Demo Data
...
This document describes the comprehensive demo data included with the Document Management System module for testing and training purposes.

## Overview

The demo data seed script (`backend/scripts/seed_dms_demo.py`) creates a fully functional Document Management System setup for the demo tenant `demo@saraise.com` with:
...
**Usage:**
```bash
python backend/scripts/seed_dms_demo.py --size basic
```
...
**Usage:**
```bash
python backend/scripts/seed_dms_demo.py --size full
```
...
**File:** `backend/scripts/seed_dms_demo.py`

**Usage:**
```bash
# Basic demo
python backend/scripts/seed_dms_demo.py --size basic --tenant demo@saraise.com

# Full demo
python backend/scripts/seed_dms_demo.py --size full --tenant demo@saraise.com

# Custom count
python backend/scripts/seed_dms_demo.py --count 50 --tenant demo@saraise.com
```
...
```bash
python backend/scripts/seed_dms_demo.py --reset --tenant demo@saraise.com
```
...
3. **Run:**
```bash
python backend/scripts/seed_dms_demo.py --custom
```
