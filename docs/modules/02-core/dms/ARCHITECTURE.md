...
**Merged from:** Dms-DESIGN.md and Dms-DESIGN-PART2.md
...
- [API Specification](#api-specification)
  - [Endpoints Overview](#endpoints-overview)
    - [GET /api/v1/dms/[resource]](#get-apiv1dmsresource)
...
|--------|----------|-------------|------|
| GET | `/api/v1/dms/[resource]` | [Description] | Required |
| POST | `/api/v1/dms/[resource]` | [Description] | Required |
| PUT | `/api/v1/dms/[resource]/{id}` | [Description] | Required |
| DELETE | `/api/v1/dms/[resource]/{id}` | [Description] | Required |

#### GET /api/v1/dms/[resource]
