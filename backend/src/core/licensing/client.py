...
class LicenseClient:
    ...
    def __init__(self, base_url: Optional[str] = None):
        ...
        """
        self.base_url = base_url or getattr(settings, "SARAISE_LICENSE_SERVER_URL", "https://license.saraise.com")
    ...
    def _validate_online(self, license_key: str, organization_id: str) -> LicenseInfo:
        ...
        raise NotImplementedError(
            "Online license validation not yet implemented. " "Use SARAISE_MODE=development for testing."
        )
    ...
    def _validate_offline(self, license_key: str, organization_id: str) -> LicenseInfo:
        ...
        raise NotImplementedError(
            "Offline license validation not yet implemented. " "Use SARAISE_MODE=development for testing."
        )
