...
_TENANT_SCOPED_MODELS = (
    ...
    "crm.Lead",
    "crm.Opportunity",
    "customization_framework.BusinessRule",
    "customization_framework.BusinessRuleVersion",
    "customization_framework.CustomFieldDefinition",
    "customization_framework.CustomFieldValue",
    "customization_framework.FormDefinition",
    "customization_framework.FormLayoutVersion",
    "customization_framework.RuleExecution",
    ...
    "dms.DocumentVersion",
    "dms.Folder",
    "document_intelligence.ClassifierModelVersion",
    "document_intelligence.ClassifierTrainingJob",
    "document_intelligence.DocumentClassification",
    "document_intelligence.DocumentClassificationScore",
    "document_intelligence.DocumentExtraction",
    "document_intelligence.DocumentExtractionPage",
    "document_intelligence.ExtractionTemplate",
    "document_intelligence.ExtractionTemplateZone",
    ...
    "metadata_modeling.DynamicResourceVersion",
    "metadata_modeling.EntityDefinition",
    "metadata_modeling.EntitySchemaVersion",
    "metadata_modeling.FieldDefinition",
    "metadata_modeling.MetadataConfigurationAudit",
    "metadata_modeling.MetadataModelingConfiguration",
    "metadata_modeling.NamingSequence",
