...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                "db_table": "data_migration_resources",
                "indexes": [
                    models.Index(fields=["tenant_id", "is_active"], name="data_migrat_tenant__edccaf_idx"),
                    models.Index(fields=["tenant_id", "name"], name="data_migrat_tenant__dae074_idx"),
                ],
            },
        ),
    ]
