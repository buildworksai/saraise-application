    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="notifications.notificationconfiguration",
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="audits",
                        to="notifications.notificationconfigurationversion",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        choices=[("", "None"), ("web", "Web"), ("android", "Android"), ("ios", "iOS")],
                        max_length=20,
                    ),
                ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(fields=["tenant_id", "user_id", "kind", "is_active"], name="notif_endpoint_user_idx")
                ],
                "constraints": [
                    ...
                    models.CheckConstraint(
                        condition=models.Q(
                            models.Q(
                                ("device_type__in", ("web", "android", "ios")),
                                ("kind", "push"),
                                ("user_id__isnull", False),
                            ),
                            models.Q(("device_type", ""), ("kind", "webhook")),
                            _connector="OR",
                        ),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "constraints": [
                    ...
                    models.CheckConstraint(
                        condition=models.Q(
                            models.Q(("quiet_hours_end__isnull", True), ("quiet_hours_start__isnull", True)),
                            models.Q(("quiet_hours_end__isnull", False), ("quiet_hours_start__isnull", False)),
                            _connector="OR",
                        ),
                    ...
                    models.CheckConstraint(
                        condition=models.Q(
                            ("category__in", ("security_alerts", "password_reset")), ("enabled", False), _negated=True
                        ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                to="notifications.notificationtemplateversion",
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("tenant_id", "configuration", "version"), name="notif_config_version_uniq"
            ),
        ),
        migrations.AddIndex(
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                condition=models.Q(
                    models.Q(("read_at__isnull", False), ("status", "read")),
                    models.Q(models.Q(("status", "read"), _negated=True), ("read_at__isnull", True)),
                    _connector="OR",
                ),
        ...
        migrations.AddConstraint(
            model_name="notification",
            constraint=models.CheckConstraint(
                condition=models.Q(("category", ""), _negated=True), name="notif_inbox_category_ck"
            ),
        ),
        migrations.AddIndex(
        ...
        migrations.AddConstraint(
            model_name="notificationtemplateversion",
            constraint=models.UniqueConstraint(
                fields=("tenant_id", "template", "version"), name="notif_tpl_version_uniq"
            ),
        ),
        migrations.AddIndex(
            model_name="notificationtemplate",
        ...
        migrations.AddConstraint(
            model_name="notificationtemplate",
            constraint=models.CheckConstraint(
                condition=models.Q(("code", ""), _negated=True), name="notif_tpl_code_nonempty"
            ),
        ),
        migrations.AddConstraint(
            model_name="notificationtemplate",
            constraint=models.CheckConstraint(
                condition=models.Q(("category", ""), _negated=True), name="notif_tpl_category_nonempty"
            ),
        ),
        migrations.AddConstraint(
            model_name="notificationtemplate",
            constraint=models.CheckConstraint(
                condition=models.Q(("name", ""), _negated=True), name="notif_tpl_name_nonempty"
            ),
        ),
        migrations.AddIndex(
            model_name="notificationdelivery",
        ...
        migrations.AddIndex(
            model_name="notificationdelivery",
            index=models.Index(
                fields=["tenant_id", "recipient_user_id", "-created_at"], name="notif_delivery_user_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="notificationdelivery",
            index=models.Index(
                fields=["tenant_id", "channel", "status", "-created_at"], name="notif_delivery_channel_idx"
            ),
        ),
        migrations.AddConstraint(
            model_name="notificationdelivery",
            constraint=models.UniqueConstraint(
                fields=("tenant_id", "idempotency_key"), name="notif_delivery_idem_uniq"
            ),
        ),
        migrations.AddConstraint(
            model_name="notificationdelivery",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                ...
                name="notif_delivery_max_attempts_ck",
            ),
        ),
        migrations.AddConstraint(
            model_name="notificationdelivery",
            constraint=models.CheckConstraint(
                ...
                name="notif_delivery_attempt_bound_ck",
            ),
        ),
        migrations.AddConstraint(
            model_name="notificationdelivery",
            constraint=models.CheckConstraint(
                condition=models.Q(
                    ...
                    models.Q(("sent_at__isnull", False), models.Q(("provider_message_id", ""), _negated=True)),
                    _connector="OR",
                ),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                condition=models.Q(
                    models.Q(("status", "delivered"), _negated=True), ("delivered_at__isnull", False), _connector="OR"
                ),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                condition=models.Q(
                    models.Q(("status", "retry_wait"), _negated=True),
