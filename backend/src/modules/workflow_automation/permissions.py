...
ACTION_ACCESS: dict[str, tuple[str, str]] = {
    ...
    "catalog": ("workflow_automation.workflow:create", "workflow_automation.api_reads"),
    "catalog_actions": ("workflow_automation.workflow:create", "workflow_automation.api_reads"),
    "catalog_conditions": ("workflow_automation.workflow:create", "workflow_automation.api_reads"),
    "catalog_subjects": ("workflow_automation.workflow:create", "workflow_automation.api_reads"),
    "catalog_assignees": ("workflow_automation.workflow:create", "workflow_automation.api_reads"),
    "catalog_lookup": ("workflow_automation.workflow:create", "workflow_automation.api_reads"),
