"""
BlockchainTraceability Models.

Defines data models for BlockchainTraceability module.
...
class TenantBaseModel(models.Model):
    ...
    class Meta:
        app_label = "blockchain_traceability"
        abstract = True
        indexes = [
...
class BlockchainTraceabilityResource(TenantBaseModel):
    """Primary resource model for BlockchainTraceability module.
    ...
    class Meta:
        app_label = "blockchain_traceability"
        db_table = "blockchain_traceability_resources"
        indexes = [
