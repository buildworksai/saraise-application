"""
Model Unit Tests for BlockchainTraceability module.
...
class TestBlockchainTraceabilityResourceModel:
    """Test BlockchainTraceabilityResource model."""
    ...
    def test_resource_has_tenant_id(self, db):
        ...
        resource = BlockchainTraceabilityResource(
            name="Test Resource",
            created_by="user-123",
        )
