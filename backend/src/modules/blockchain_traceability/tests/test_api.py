"""
API Integration Tests for BlockchainTraceability module.
...
class TestBlockchainTraceabilityResourceViewSet:
    """Test BlockchainTraceabilityResourceViewSet CRUD operations."""
    ...
    def test_list_resources(self, authenticated_client, tenant_user):
        ...
        BlockchainTraceabilityResource.objects.create(
            tenant_id=tenant_id,
    ...
    def test_get_resource_detail(self, authenticated_client, tenant_user):
        ...
        response = authenticated_client.get(f"/api/v1/blockchain-traceability/resources/{resource.id}/")
        assert response.status_code == status.HTTP_200_OK
