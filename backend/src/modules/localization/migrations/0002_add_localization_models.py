    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "context",
                    models.CharField(
                        blank=True, help_text="Context (e.g., 'module', 'page', 'component')", max_length=100
                    ),
                ),
                (
                    "language",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["tenant_id", "language", "key"], name="localization_tenant__language__key_idx"
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "timezone",
                    models.CharField(
                        default="UTC", help_text="IANA timezone (e.g., 'America/New_York')", max_length=100
                    ),
                ),
                ...
                (
                    "number_format",
                    models.CharField(
                        default="en-US", help_text="Number format locale (e.g., 'en-US', 'de-DE')", max_length=50
                    ),
                ),
                (
                    "default_language",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "exchange_rates",
                    models.JSONField(default=dict, help_text="Exchange rates relative to default currency"),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "business_days",
                    models.JSONField(default=list, help_text="List of business days (0=Monday, 6=Sunday)"),
                ),
            ],
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["tenant_id", "country_code"], name="localization_regional_tenant__country_idx"
                    ),
                ],
            },
        ),
