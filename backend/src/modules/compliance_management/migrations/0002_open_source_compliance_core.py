...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "source_kind",
                    models.CharField(
                        choices=[("custom", "Custom"), ("imported", "Imported"), ("extension", "Extension")],
                        max_length=20,
                    ),
                ),
            ...
            options={
                ...
                "constraints": [
                    ...
                    models.CheckConstraint(
                        condition=models.Q(("source_kind", "extension"), _negated=True)
                        | models.Q(("source_package", ""), _negated=True),
        ...
        migrations.AlterField(
            "compliancepolicy", "effective_date", models.DateField(blank=True, db_index=True, null=True)
        ),
        ...
        migrations.AddField(
            ...
            models.ForeignKey(
                ...
                to="compliance_management.complianceframework",
            ),
        ),
        ...
        migrations.AddField(
            ...
            "tags",
            models.JSONField(
                blank=True, default=list, validators=[src.modules.compliance_management.models.validate_tags]
            ),
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "content_sha256",
                    models.CharField(
                        max_length=64, validators=[src.modules.compliance_management.models.validate_sha256]
                    ),
                ),
            ...
            options={
                ...
                "constraints": [
                    ...
                    models.UniqueConstraint(
                        fields=("tenant_id", "policy", "content_sha256"), name="cmp_pol_ver_content_uq"
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("content_sha256__regex", "^[0-9a-f]{64}$")), name="cmp_pol_ver_sha256_ck"
                    ),
                ],
            },
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="requirement_mappings",
                        to="compliance_management.compliancepolicyversion",
                    ),
                ),
                (
                    "requirement",
                    models.ForeignKey(
                        ...
                        to="compliance_management.compliancerequirement",
                    ),
                ),
            ],
            options={
                ...
                "constraints": [
                    ...
                    models.CheckConstraint(
                        condition=models.Q(("coverage", "full")) | models.Q(("rationale", ""), _negated=True),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "source",
                    models.CharField(
                        choices=[("manual", "Manual"), ("import", "Import"), ("extension", "Extension")], max_length=20
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="compliance_management.requirementpolicymapping",
                    ),
                ),
                (
                    "requirement",
            ...
            options={
                ...
                "constraints": [
                    models.CheckConstraint(
                        condition=models.Q(("status__in", ("not_assessed", "in_progress", "compliant")))
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        max_length=64,
                        validators=[src.modules.compliance_management.models.validate_optional_sha256],
                    ),
                ),
                (
                    "classification",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["tenant_id", "classification", "collected_at"], name="cmp_evid_tenant_class_ix"
                    ),
                ...
                "constraints": [
                    models.CheckConstraint(
                        condition=(
                            (
                                models.Q(reference_kind="dms_document")
                                & models.Q(document_id__isnull=False)
                                & models.Q(external_uri="")
                                & models.Q(text_reference="")
                            )
                            | (
                                models.Q(reference_kind="external_url")
                                & models.Q(document_id__isnull=True)
                                & ~models.Q(external_uri="")
                                & models.Q(text_reference="")
                            )
                            | (
                                models.Q(reference_kind="text_reference")
                                & models.Q(document_id__isnull=True)
                                & models.Q(external_uri="")
                                & ~models.Q(text_reference="")
                            )
                    ...
                    models.CheckConstraint(
                        ...
                        | models.Q(("valid_from__isnull", False), ("valid_until__gt", models.F("valid_from"))),
                        name="cmp_evidence_validity_ck",
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("sha256", "")) | models.Q(("sha256__regex", "^[0-9a-f]{64}$")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="compliance_management.complianceevidence",
                    ),
                ),
                (
                    "requirement",
            ...
            options={
                ...
                "constraints": [
                    models.UniqueConstraint(
                        fields=("tenant_id", "evidence", "requirement"), name="cmp_evid_link_tenant_uq"
                    )
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.JSONField(
                        default=list,
                        validators=[src.modules.compliance_management.models.validate_regulation_categories],
                    ),
                ),
                (
                    "rollout",
                    models.JSONField(
                        blank=True, default=dict, validators=[src.modules.compliance_management.models.validate_rollout]
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["tenant_id", "environment", "status", "-version"], name="cmp_cfg_tenant_env_status_ix"
                    )
                ],
                "constraints": [
                    models.UniqueConstraint(
                        fields=("tenant_id", "environment", "version"), name="cmp_cfg_tenant_env_version_uq"
                    ),
                    models.UniqueConstraint(
                    ...
                    models.CheckConstraint(
                        condition=models.Q(("default_review_frequency_days__range", (1, 3650))),
                        name="cmp_cfg_review_range_ck",
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("expiry_warning_days__range", (0, 365))), name="cmp_cfg_expiry_range_ck"
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("evidence_warning_days__range", (0, 365))), name="cmp_cfg_evidence_range_ck"
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("minimum_assessment_note_length__range", (0, 2000))),
                        name="cmp_cfg_note_range_ck",
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("bulk_import_row_limit__range", (1, 10000))), name="cmp_cfg_import_range_ck"
                    ),
                ],
            },
        ),
