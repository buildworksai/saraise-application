"""
BackupDisasterRecovery Models.

Defines data models for BackupDisasterRecovery module.
...
class BackupDisasterRecoveryResource(TenantBaseModel):
    """Primary resource model for BackupDisasterRecovery module.
    ...
    class Meta:
        app_label = "backup_disaster_recovery"
        db_table = "backup_disaster_recovery_resources"
        indexes = [
