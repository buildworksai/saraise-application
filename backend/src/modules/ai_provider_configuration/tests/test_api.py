...
from ..models import AiProviderConfigurationResource
...
class TestAiProviderConfigurationResourceViewSet:
    """Test AiProviderConfigurationResourceViewSet CRUD operations."""
    ...
    def test_list_resources(self, authenticated_client, tenant_user):
        ...
        AiProviderConfigurationResource.objects.create(
            tenant_id=tenant_id,
    ...
    def test_get_resource_detail(self, authenticated_client, tenant_user):
        ...
        resource = AiProviderConfigurationResource.objects.create(
            tenant_id=tenant_id,
            name="Test Resource",
    ...
    def test_delete_resource(self, authenticated_client, tenant_user):
        ...
        assert not AiProviderConfigurationResource.objects.filter(id=resource.id).exists()
