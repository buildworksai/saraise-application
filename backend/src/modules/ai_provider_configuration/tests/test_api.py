...
class TestTenantBaseModelViewSet:
    ...
    def test_create_resource(self, authenticated_client, tenant_user):
        ...
        response = authenticated_client.post("/api/v1/ai-provider-configuration/resources/", data, format="json")
    ...
    def test_update_resource(self, authenticated_client, tenant_user):
        ...
        response = authenticated_client.put(
            f"/api/v1/ai-provider-configuration/resources/{resource.id}/", data, format="json"
        )
        assert response.status_code == status.HTTP_200_OK
