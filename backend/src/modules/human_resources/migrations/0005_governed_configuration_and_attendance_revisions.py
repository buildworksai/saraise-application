    ...
    operations = [
            ...
            options={
                ...
                "constraints": [
                    models.UniqueConstraint(
                        fields=("tenant_id", "environment"), name="hr_config_tenant_environment_uq"
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("version__gte", 1)), name="hr_config_version_positive_ck"
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("environment", ""), _negated=True), name="hr_config_environment_nonempty_ck"
                    ),
                    models.CheckConstraint(
                        condition=models.Q(
                            ("actor_identifier_max_length__gte", 32), ("actor_identifier_max_length__lte", 1024)
                        ),
                        name="hr_config_actor_limit_safe_ck",
                    ),
                    models.CheckConstraint(
                        condition=models.Q(
                            ("idempotency_key_max_length__gte", 16), ("idempotency_key_max_length__lte", 1024)
                        ),
                        name="hr_config_idem_limit_safe_ck",
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("hierarchy_max_depth__gte", 1), ("hierarchy_max_depth__lte", 500)),
                        name="hr_config_hierarchy_depth_safe_ck",
                    ),
                    models.CheckConstraint(
                        condition=models.Q(
                            ("reporting_tree_max_depth__gte", 1), ("reporting_tree_max_depth__lte", 100)
                        ),
                        name="hr_config_reporting_depth_safe_ck",
                    ),
                    models.CheckConstraint(
                        condition=models.Q(
                            ("department_tree_max_nodes__gte", 1), ("department_tree_max_nodes__lte", 10000)
                        ),
                        name="hr_config_tree_nodes_safe_ck",
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("max_hours_per_day__gt", 0), ("max_hours_per_day__lte", 24)),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "constraints": [
                    models.UniqueConstraint(
                        fields=("tenant_id", "attendance", "revision"), name="hr_attrev_t_att_revision_uq"
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("revision__gte", 1)), name="hr_attrev_revision_positive_ck"
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("reason", ""), _negated=True), name="hr_attrev_reason_nonempty_ck"
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("actor_id", ""), _negated=True), name="hr_attrev_actor_nonempty_ck"
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("correlation_id", ""), _negated=True),
                        name="hr_attrev_correlation_nonempty_ck",
                    ),
                ],
            },
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="human_resources.humanresourcesconfiguration",
                    ),
                ),
            ],
            options={
                ...
                "constraints": [
                    models.UniqueConstraint(
                        fields=("tenant_id", "environment", "idempotency_key"), name="hr_cfgaudit_t_env_idempotency_uq"
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("version__gte", 1)), name="hr_cfgaudit_version_positive_ck"
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("action", ""), _negated=True), name="hr_cfgaudit_action_nonempty_ck"
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("actor_id", ""), _negated=True), name="hr_cfgaudit_actor_nonempty_ck"
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("correlation_id", ""), _negated=True),
                        name="hr_cfgaudit_correlation_nonempty_ck",
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "constraints": [
                    models.UniqueConstraint(
                        fields=("tenant_id", "environment", "version"), name="hr_config_version_t_env_version_uq"
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("version__gte", 1)), name="hr_config_snapshot_version_positive_ck"
                    ),
                    models.CheckConstraint(
                        condition=models.Q(
                            ("rolled_back_from_version__isnull", True),
                            ("rolled_back_from_version__gte", 1),
                            _connector="OR",
                        ),
