...
def restore_legacy_writes(apps, schema_editor):
    ...
    schema_editor.execute(
        "DROP TRIGGER IF EXISTS process_mining_legacy_read_only ON process_mining_resources; DROP FUNCTION IF EXISTS process_mining_legacy_reject_write();"
    )
...
def remove_same_tenant_guards(apps, schema_editor):
    ...
    for child, column, _parent in reversed(RELATIONSHIPS):
        trigger = f"pm_same_tenant_{column}_{child[-8:]}"
        schema_editor.execute(
            f"DROP TRIGGER IF EXISTS {schema_editor.quote_name(trigger)} ON {schema_editor.quote_name(child)};"
        )
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(
                        fields=["tenant_id", "process_name", "case_id", "occurred_at"], name="pm_evt_case_time"
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                *mutable_fields(),
                ("process_name", models.CharField(max_length=255)),
                ("format", models.CharField(choices=[("xes", "XES"), ("csv", "CSV"), ("json", "JSON")], max_length=32)),
                ("event_filter", models.JSONField(default=dict)),
                ("status", models.CharField(choices=EXPORT_CHOICES, default="queued", max_length=24)),
                ("transition_history", models.JSONField(default=list, editable=False)),
                ("async_job_id", models.UUIDField(db_index=True, null=True, unique=True)),
                ("idempotency_key", models.CharField(max_length=255)),
                ("artifact_key", models.CharField(blank=True, max_length=1024)),
            ...
            options={
                ...
                "constraints": [
                    models.UniqueConstraint(fields=("tenant_id", "idempotency_key"), name="pm_export_idem_uniq")
                ],
                "indexes": [
        ...
        migrations.CreateModel(
            ...
            fields=[
                *mutable_fields(),
                ("process_name", models.CharField(max_length=255)),
                ("algorithm", models.CharField(choices=ALGORITHM_CHOICES, max_length=160)),
                ("parameters", models.JSONField(default=dict)),
                ("status", models.CharField(choices=ANALYSIS_CHOICES, default="queued", max_length=24)),
                ("transition_history", models.JSONField(default=list, editable=False)),
                ("async_job_id", models.UUIDField(db_index=True, null=True, unique=True)),
                ("idempotency_key", models.CharField(max_length=255)),
            ...
            options={
                ...
                "constraints": [
                    ...
                    models.CheckConstraint(
                        condition=models.Q(("activity_count__gte", 0)), name="pm_disc_activity_nonneg"
                    ),
                ],
                "indexes": [
                    models.Index(
                        fields=["tenant_id", "process_name", "status", "created_at"], name="pm_disc_status_time"
                    )
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                *mutable_fields(),
                ...
                (
                    "source_kind",
                    models.CharField(choices=[("discovered", "Discovered"), ("imported", "Imported")], max_length=24),
                ),
            ...
            options={
                ...
                "constraints": [
                    models.UniqueConstraint(
                        ...
                        name="pm_model_active_name_uniq",
                    ),
                    models.CheckConstraint(
                        condition=models.Q(
                            ("reference_version_number__isnull", True),
                            ("reference_version_number__gt", 0),
                            _connector="OR",
                        ),
                ...
                "indexes": [
                    models.Index(fields=["tenant_id", "process_name", "created_at"], name="pm_model_process_time")
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                *mutable_fields(),
                ...
                ("avg_case_duration_seconds", models.DecimalField(decimal_places=2, max_digits=14, null=True)),
                ("started_at", models.DateTimeField(null=True)),
                ("completed_at", models.DateTimeField(null=True)),
                ("error_code", models.CharField(blank=True, max_length=100)),
                ("error_message", models.TextField(blank=True)),
            ...
            options={
                ...
                "constraints": [
                    ...
                    models.CheckConstraint(
                        condition=models.Q(("time_range_end__gt", models.F("time_range_start"))),
                        name="pm_bneck_time_order",
                    ),
                ],
                "indexes": [
                    models.Index(
                        fields=["tenant_id", "process_name", "status", "created_at"], name="pm_bneck_status_time"
                    )
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                *append_fields(),
                ...
                ("algorithm", models.CharField(blank=True, choices=ALGORITHM_CHOICES, max_length=160, null=True)),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="process_mining.processdiscoveryjob",
                    ),
                ),
                (
                    "process_model",
            ...
            options={
                ...
                "constraints": [
                    models.UniqueConstraint(
                        fields=("tenant_id", "process_model", "version"), name="pm_model_version_uniq"
                    ),
                    models.UniqueConstraint(
                    ...
                    models.CheckConstraint(
                        condition=models.Q(("activity_count__gte", 0)), name="pm_ver_activity_nonneg"
                    ),
                    models.CheckConstraint(
                        condition=models.Q(
                            ("avg_case_duration_seconds__isnull", True),
                            ("avg_case_duration_seconds__gte", 0),
                            _connector="OR",
                        ),
                ...
                "indexes": [
                    models.Index(fields=["tenant_id", "process_model", "published_at"], name="pm_version_model_time")
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                *mutable_fields(),
                ...
                ("async_job_id", models.UUIDField(db_index=True, null=True, unique=True)),
                ("idempotency_key", models.CharField(max_length=255)),
                ("fitness", models.DecimalField(decimal_places=4, max_digits=5, null=True)),
                ("precision", models.DecimalField(decimal_places=4, max_digits=5, null=True)),
                ("generalization", models.DecimalField(decimal_places=4, max_digits=5, null=True)),
            ...
            options={
                    ...
                    *[
                        models.CheckConstraint(
                            condition=models.Q(
                                ...
                                models.Q((f"{field}__gte", Decimal("0")), (f"{field}__lte", Decimal("1"))),
                                _connector="OR",
                            ),
                    ...
                    models.CheckConstraint(
                        condition=models.Q(
                            ...
                            ("total_cases", models.F("conformant_cases") + models.F("deviating_cases")),
                            _connector="OR",
                        ),
                ...
                "indexes": [
                    models.Index(
                        fields=["tenant_id", "process_model_version", "status", "created_at"],
                        name="pm_conf_status_time",
                    )
                ],
            },
        ),
                ...
                *append_fields(),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="process_mining.conformancecheck",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                *append_fields(),
                ("case_id", models.CharField(max_length=255)),
                ("fitness", models.DecimalField(decimal_places=4, max_digits=5)),
            ...
            options={
                ...
                "constraints": [
                    models.UniqueConstraint(
                        fields=("tenant_id", "conformance_check", "case_id"), name="pm_case_metric_uniq"
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("fitness__gte", Decimal("0")), ("fitness__lte", Decimal("1"))),
                        name="pm_case_fitness_range",
                    ),
                ],
                "indexes": [
                    models.Index(fields=["tenant_id", "conformance_check", "fitness"], name="pm_case_fit_check")
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                *append_fields(),
                ...
                ("avg_duration_seconds", models.DecimalField(decimal_places=2, max_digits=14)),
                ("median_duration_seconds", models.DecimalField(decimal_places=2, max_digits=14)),
                ("p95_duration_seconds", models.DecimalField(decimal_places=2, max_digits=14)),
                ...
                ("resource_bottleneck", models.CharField(blank=True, max_length=255)),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="process_mining.bottleneckanalysis",
                    ),
                ),
            ],
            options={
                ...
                "constraints": [
                    ...
                    models.CheckConstraint(
                        condition=models.Q(("avg_duration_seconds__gte", 0)), name="pm_find_avg_nonneg"
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("median_duration_seconds__gte", 0)), name="pm_find_median_nonneg"
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("p95_duration_seconds__gte", 0)), name="pm_find_p95_nonneg"
                    ),
                ],
                "indexes": [
                    models.Index(fields=["tenant_id", "analysis", "severity", "rank"], name="pm_find_severity_rank")
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "constraints": [
                    models.UniqueConstraint(
                        fields=("tenant_id", "analysis", "variant_key"), name="pm_variant_key_uniq"
                    ),
                    models.UniqueConstraint(
                        condition=models.Q(("is_happy_path", True)),
                        fields=("tenant_id", "analysis"),
                        name="pm_variant_happy_uniq",
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("percentage__gte", 0), ("percentage__lte", 100)),
                        name="pm_variant_pct_range",
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("avg_duration_seconds__gte", 0)), name="pm_variant_duration_nonneg"
                    ),
                ],
