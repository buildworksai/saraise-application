"""
ProcessMining Models.

Defines data models for ProcessMining module.
...
class ProcessMiningResource(TenantBaseModel):
    """Primary resource model for ProcessMining module.
    ...
    class Meta:
        app_label = "process_mining"
        db_table = "process_mining_resources"
        indexes = [
