...
class TestProcessMiningTenantIsolation:
    """
    CRITICAL: Tenant isolation tests for ProcessMiningResource model.
    ...
    def test_user_cannot_list_other_tenant_resources(self, api_client, tenant_a_user, tenant_b_user):
        ...
        resource_a = ProcessMiningResource.objects.create(
        ...
        resource_b = ProcessMiningResource.objects.create(
    ...
    def test_user_cannot_delete_other_tenant_resource(self, api_client, tenant_a_user, tenant_b_user):
        ...
        assert ProcessMiningResource.objects.filter(id=resource_b.id).exists()
