                ...
                credential.transition_history = [
                    {
                        ...
                        "metadata": {
                            "actor_id": str(credential.created_by),
                            "reason": "Legacy credential superseded during UUID reconciliation",
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            "status",
            models.CharField(
                choices=[("inactive", "Inactive"), ("testing", "Testing"), ("active", "Active"), ("error", "Error")],
                default="inactive",
                max_length=20,
            ),
        ),
        ...
        migrations.AlterField(
            ...
            "status",
            models.CharField(
                choices=[("inactive", "Inactive"), ("active", "Active"), ("error", "Error")],
                default="inactive",
                max_length=20,
            ),
        ),
        ...
        migrations.AddIndex(
            "integrationcredential",
            models.Index(fields=("tenant_id", "integration", "status"), name="intplat_cred_tenant_int_idx"),
        ),
        migrations.AddIndex(
            "webhook", models.Index(fields=("tenant_id", "direction", "status"), name="intplat_hook_tenant_dir_idx")
        ),
        migrations.AddIndex(
            "webhookdelivery",
