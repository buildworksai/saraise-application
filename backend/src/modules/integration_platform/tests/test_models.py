"""
Model Unit Tests for IntegrationPlatform module.
...
class TestIntegrationPlatformResourceModel:
    """Test IntegrationPlatformResource model."""
    ...
    def test_resource_has_tenant_id(self, db):
        ...
        resource = IntegrationPlatformResource(
            name="Test Resource",
            created_by="user-123",
        )
