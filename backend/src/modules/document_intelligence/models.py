"""
DocumentIntelligence Models.

Defines data models for DocumentIntelligence module.
...
class DocumentIntelligenceResource(TenantBaseModel):
    """Primary resource model for DocumentIntelligence module.
