...
class TestDocumentIntelligenceTenantIsolation:
    """
    CRITICAL: Tenant isolation tests for DocumentIntelligenceResource model.
    ...
    def test_user_cannot_list_other_tenant_resources(self, api_client, tenant_a_user, tenant_b_user):
        ...
        resource_a = DocumentIntelligenceResource.objects.create(
        ...
        resource_b = DocumentIntelligenceResource.objects.create(
    ...
    def test_user_cannot_delete_other_tenant_resource(self, api_client, tenant_a_user, tenant_b_user):
        ...
        assert DocumentIntelligenceResource.objects.filter(id=resource_b.id).exists()
