...
class TestTenantBaseModelViewSet:
    ...
    def test_list_resources_requires_authentication(self, api_client):
        ...
        response = api_client.get("/api/v1/document-intelligence/resources/")
    ...
    def test_list_resources(self, authenticated_client, tenant_user):
        ...
        response = authenticated_client.get("/api/v1/document-intelligence/resources/")
        assert response.status_code == status.HTTP_200_OK
    ...
    def test_create_resource(self, authenticated_client, tenant_user):
        ...
        response = authenticated_client.post("/api/v1/document-intelligence/resources/", data, format="json")
    ...
    def test_update_resource(self, authenticated_client, tenant_user):
        ...
        response = authenticated_client.put(
            f"/api/v1/document-intelligence/resources/{resource.id}/", data, format="json"
        )
        assert response.status_code == status.HTTP_200_OK
