...
def _call(operation: Callable[[], Any]) -> Any:
    ...
    try:
        ...
        detail = getattr(exc, "message_dict", None) or {
            "non_field_errors": getattr(exc, "messages", ["Inventory validation failed."])
        }
...
class WarehouseViewSet(InventoryViewSet):
    ...
    serializer_classes = {
        ...
        "destroy": WarehouseDetailSerializer,
        "set_default": WarehouseDetailSerializer,
    }  # noqa: F405
    ...
    def create(self, request: Request) -> Response:
        ...
        obj = _call(
            lambda: WarehouseService.create(
                _tenant(request), _actor(request), dict(serializer.validated_data), _idempotency_key(request)
            )
        )
    ...
    def partial_update(self, request: Request, pk: str | None = None) -> Response:
        ...
        updated = _call(
            lambda: WarehouseService.update(
                _tenant(request), obj.id, _expected_version(request, command), _actor(request), command
            )
        )
    ...
    def destroy(self, request: Request, pk: str | None = None) -> Response:
        obj = self.get_object()
        archived = _call(
            lambda: WarehouseService.archive(_tenant(request), obj.id, _expected_version(request, {}), _actor(request))
        )
    ...
    def set_default(self, request: Request, pk: str | None = None) -> Response:
        obj = self.get_object()
        updated = _call(
            lambda: WarehouseService.set_default(_tenant(request), obj.id, _actor(request), _idempotency_key(request))
        )
        return Response(WarehouseDetailSerializer(updated).data)  # noqa: F405
...
class StorageLocationViewSet(InventoryViewSet):
    ...
    action_permissions = {
        "list": LOCATION_READ,
        "retrieve": LOCATION_READ,
        "create": LOCATION_CREATE,
        "partial_update": LOCATION_UPDATE,
        "destroy": LOCATION_DELETE,
    }  # noqa: F405
    serializer_classes = {
        "list": StorageLocationListSerializer,
        "retrieve": StorageLocationDetailSerializer,
        "create": StorageLocationCreateSerializer,
        "partial_update": StorageLocationUpdateSerializer,
        "destroy": StorageLocationDetailSerializer,
    }  # noqa: F405
    ...
    def create(self, request: Request) -> Response:
        ...
        serializer.is_valid(raise_exception=True)
        obj = _call(
            lambda: StorageLocationService.create(
                _tenant(request), _actor(request), dict(serializer.validated_data), _idempotency_key(request)
            )
        )
    ...
    def partial_update(self, request: Request, pk: str | None = None) -> Response:
        obj = self.get_object()
        serializer = StorageLocationUpdateSerializer(data=request.data, partial=True)  # noqa: F405,E702
        serializer.is_valid(raise_exception=True)
        command = dict(serializer.validated_data)  # noqa: E702
        result = _call(
            lambda: StorageLocationService.update(
                _tenant(request), obj.id, _expected_version(request, command), _actor(request), command
            )
        )
    ...
    def destroy(self, request: Request, pk: str | None = None) -> Response:
        obj = self.get_object()
        result = _call(
            lambda: StorageLocationService.archive(
                _tenant(request), obj.id, _expected_version(request, {}), _actor(request)
            )
        )
        return Response(StorageLocationDetailSerializer(result).data)  # noqa: F405
...
class ItemViewSet(InventoryViewSet):
    ...
    def partial_update(self, request: Request, pk: str | None = None) -> Response:
        obj = self.get_object()
        serializer = ItemUpdateSerializer(data=request.data, partial=True)  # noqa: F405,E702
        serializer.is_valid(raise_exception=True)
        command = dict(serializer.validated_data)  # noqa: E702
        result = _call(
            lambda: ItemService.update(
                _tenant(request), obj.id, _expected_version(request, command), _actor(request), command
            )
        )
    ...
    def destroy(self, request: Request, pk: str | None = None) -> Response:
        obj = self.get_object()
        result = _call(
            lambda: ItemService.archive(_tenant(request), obj.id, _expected_version(request, {}), _actor(request))
        )
        return Response(ItemDetailSerializer(result).data)  # noqa: F405
...
class BatchViewSet(InventoryViewSet):
    ...
    action_permissions = {
        ...
        "retrieve": BATCH_READ,
        "create": BATCH_CREATE,
        "partial_update": BATCH_UPDATE,
        "activate": BATCH_TRANSITION,
        "quarantine": BATCH_TRANSITION,
        "release": BATCH_TRANSITION,
        "recall": BATCH_TRANSITION,
        "trace": BATCH_READ,
    }  # noqa: F405
    serializer_classes = {
        ...
        "activate": VersionedCommandSerializer,
        "quarantine": VersionedCommandSerializer,
        "release": VersionedCommandSerializer,
        "recall": ReasonCommandSerializer,
        "trace": StockLedgerSerializer,
    }  # noqa: F405
    ...
    def apply_filters(self, queryset: QuerySet[Any], params: Mapping[str, Any]) -> QuerySet[Any]:
        if params.get("expires_before"):
            queryset = queryset.filter(expires_on__lte=params["expires_before"])
        if params.get("expires_after"):
            queryset = queryset.filter(expires_on__gte=params["expires_after"])
        return queryset
    ...
    def partial_update(self, request: Request, pk: str | None = None) -> Response:
        obj = self.get_object()
        serializer = BatchUpdateSerializer(data=request.data, partial=True)  # noqa: F405,E702
        serializer.is_valid(raise_exception=True)
        command = dict(serializer.validated_data)  # noqa: E702
        result = _call(
            lambda: BatchService.update_metadata(
                _tenant(request), obj.id, _expected_version(request, command), _actor(request), command
            )
        )
    ...
    def _transition(self, request: Request, method: str) -> Response:
        obj = self.get_object()
        serializer = self.get_serializer(data=request.data)  # noqa: E702
        serializer.is_valid(raise_exception=True)
        result = _call(
            lambda: getattr(BatchService, method)(_tenant(request), obj.id, _actor(request), _idempotency_key(request))
        )
        return Response(BatchDetailSerializer(result).data)  # noqa: F405
    ...
    @action(detail=True, methods=["post"])
    def quarantine(self, request: Request, pk: str | None = None) -> Response:
        return self._transition(request, "quarantine")
    ...
    def recall(self, request: Request, pk: str | None = None) -> Response:
        return self._transition(request, "recall")
...
class SerialNumberViewSet(InventoryViewSet):
    ...
    action_permissions = {
        "list": SERIAL_READ,
        "retrieve": SERIAL_READ,
        "create": SERIAL_CREATE,
        "partial_update": SERIAL_UPDATE,
        "trace": SERIAL_READ,
    }  # noqa: F405
    serializer_classes = {
        "list": SerialNumberListSerializer,
        "retrieve": SerialNumberDetailSerializer,
        "create": SerialNumberCreateSerializer,
        "partial_update": SerialNumberUpdateSerializer,
        "trace": SerialNumberDetailSerializer,
    }  # noqa: F405
    ...
    def create(self, request: Request) -> Response:
        serializer = SerialNumberCreateSerializer(data=request.data)
        serializer.is_valid(raise_exception=True)  # noqa: F405,E702
        obj = _call(
            lambda: SerialNumberService.register(
                _tenant(request), _actor(request), dict(serializer.validated_data), _idempotency_key(request)
            )
        )
    ...
    def partial_update(self, request: Request, pk: str | None = None) -> Response:
        obj = self.get_object()
        serializer = SerialNumberUpdateSerializer(data=request.data, partial=True)  # noqa: F405,E702
        serializer.is_valid(raise_exception=True)
        command = dict(serializer.validated_data)  # noqa: E702
        result = _call(
            lambda: SerialNumberService.update_metadata(
                _tenant(request), obj.id, _expected_version(request, command), _actor(request), command
            )
        )
...
class StockEntryViewSet(InventoryViewSet):
    model = StockEntry
    action_permissions = {
        "list": STOCK_ENTRY_READ,
        "retrieve": STOCK_ENTRY_READ,
        "create": STOCK_ENTRY_CREATE,
        "partial_update": STOCK_ENTRY_UPDATE,
        "destroy": STOCK_ENTRY_DELETE,
        "submit": STOCK_ENTRY_SUBMIT,
        "approve": STOCK_ENTRY_APPROVE,
        "reject": STOCK_ENTRY_REJECT,
        "post": STOCK_ENTRY_POST,
        "cancel": STOCK_ENTRY_CANCEL,
        "reverse": STOCK_ENTRY_REVERSE,
    }  # noqa: F405
    action_quotas = {"post": POST_QUOTA}  # noqa: F405
    serializer_classes = {
        "list": StockEntryListSerializer,
        "retrieve": StockEntryDetailSerializer,
        "create": StockEntryCreateSerializer,
        "partial_update": StockEntryUpdateSerializer,
        "destroy": StockEntryDetailSerializer,
        "submit": VersionedCommandSerializer,
        "approve": VersionedCommandSerializer,
        "reject": ReasonCommandSerializer,
        "post": VersionedCommandSerializer,
        "cancel": ReasonCommandSerializer,
        "reverse": ReasonCommandSerializer,
    }  # noqa: F405
    ...
    def apply_filters(self, queryset: QuerySet[Any], params: Mapping[str, Any]) -> QuerySet[Any]:
        if params.get("from"):
            queryset = queryset.filter(posting_at__gte=params["from"])
        if params.get("to"):
            queryset = queryset.filter(posting_at__lte=params["to"])
        if params.get("warehouse_id"):
            queryset = queryset.filter(
                Q(source_warehouse_id=params["warehouse_id"]) | Q(destination_warehouse_id=params["warehouse_id"])
            )
        return queryset
    ...
    def create(self, request: Request) -> Response:
        ...
        serializer.is_valid(raise_exception=True)  # noqa: F405,E702
        obj = _call(
            lambda: StockEntryService.create_draft(
                _tenant(request), _actor(request), dict(serializer.validated_data), _idempotency_key(request)
            )
        )
    ...
    def partial_update(self, request: Request, pk: str | None = None) -> Response:
        obj = self.get_object()
        serializer = StockEntryUpdateSerializer(data=request.data, partial=True)  # noqa: F405,E702
        serializer.is_valid(raise_exception=True)
        command = dict(serializer.validated_data)  # noqa: E702
        result = _call(
            lambda: StockEntryService.update_draft(
                _tenant(request), obj.id, _expected_version(request, command), _actor(request), command
            )
        )
    ...
    def destroy(self, request: Request, pk: str | None = None) -> Response:
        obj = self.get_object()
        result = _call(
            lambda: StockEntryService.delete_draft(
                _tenant(request), obj.id, _expected_version(request, {}), _actor(request)
            )
        )
        return Response(StockEntryDetailSerializer(result).data)  # noqa: F405
    ...
    def _command(self, request: Request, method: str, *, posting: bool = False) -> Response:
        ...
        serializer = self.get_serializer(data=request.data)  # noqa: E702
        serializer.is_valid(raise_exception=True)
        values = dict(serializer.validated_data)  # noqa: E702
        key = _idempotency_key(request)
        if posting:
            result = _call(lambda: InventoryPostingService.post(_tenant(request), obj.id, _actor(request), key))
        elif method == "reverse":
            result = _call(
                lambda: StockEntryService.reverse(_tenant(request), obj.id, _actor(request), values["reason"], key)
            )
        else:
    ...
    def submit(self, request: Request, pk: str | None = None) -> Response:
        return self._command(request, "submit")

    @action(detail=True, methods=["post"])
    def approve(self, request: Request, pk: str | None = None) -> Response:
        return self._command(request, "approve")

    @action(detail=True, methods=["post"])
    def reject(self, request: Request, pk: str | None = None) -> Response:
        return self._command(request, "reject")

    @action(detail=True, methods=["post"])
    def post(self, request: Request, pk: str | None = None) -> Response:
        return self._command(request, "post", posting=True)

    @action(detail=True, methods=["post"])
    def cancel(self, request: Request, pk: str | None = None) -> Response:
        return self._command(request, "cancel")

    @action(detail=True, methods=["post"])
    def reverse(self, request: Request, pk: str | None = None) -> Response:
        return self._command(request, "reverse")
...
class StockBalanceViewSet(InventoryViewSet):
    ...
    def apply_filters(self, queryset: QuerySet[Any], params: Mapping[str, Any]) -> QuerySet[Any]:
        if str(params.get("nonzero", "")).lower() in {"1", "true"}:
            queryset = queryset.exclude(quantity_on_hand=0)
        if str(params.get("below_reorder", "")).lower() in {"1", "true"}:
            queryset = queryset.filter(
                item__reorder_point__isnull=False, quantity_available__lt=F("item__reorder_point")
            )
        return queryset
...
class StockLedgerViewSet(InventoryViewSet):
    ...
    def apply_filters(self, queryset: QuerySet[Any], params: Mapping[str, Any]) -> QuerySet[Any]:
        if params.get("from"):
            queryset = queryset.filter(posted_at__gte=params["from"])
        if params.get("to"):
            queryset = queryset.filter(posted_at__lte=params["to"])
        return queryset
...
class ReservationViewSet(InventoryViewSet):
    ...
    action_permissions = {
        "list": RESERVATION_READ,
        "retrieve": RESERVATION_READ,
        "create": RESERVATION_CREATE,
        "partial_update": RESERVATION_UPDATE,
        "release": RESERVATION_TRANSITION,
        "consume": RESERVATION_TRANSITION,
        "cancel": RESERVATION_TRANSITION,
    }  # noqa: F405
    serializer_classes = {
        ...
        "release": VersionedCommandSerializer,
        "consume": ReservationConsumeSerializer,
        "cancel": ReasonCommandSerializer,
    }  # noqa: F405
    ...
    def create(self, request: Request) -> Response:
        ...
        serializer.is_valid(raise_exception=True)  # noqa: F405,E702
        obj = _call(
            lambda: ReservationService.reserve(
                _tenant(request), _actor(request), dict(serializer.validated_data), _idempotency_key(request)
            )
        )
    ...
    def partial_update(self, request: Request, pk: str | None = None) -> Response:
        obj = self.get_object()
        serializer = ReservationUpdateSerializer(data=request.data, partial=True)  # noqa: F405,E702
        serializer.is_valid(raise_exception=True)
        command = dict(serializer.validated_data)  # noqa: E702
        result = _call(
            lambda: ReservationService.update(
                _tenant(request), obj.id, _expected_version(request, command), _actor(request), command
            )
        )
    ...
    def _transition(self, request: Request, method: str) -> Response:
        ...
        serializer.is_valid(raise_exception=True)
        result = _call(
            lambda: getattr(ReservationService, method)(
                _tenant(request), obj.id, _actor(request), _idempotency_key(request)
            )
        )
        return Response(ReservationDetailSerializer(result).data)  # noqa: F405
    ...
    @action(detail=True, methods=["post"])
    def consume(self, request: Request, pk: str | None = None) -> Response:
        return self._transition(request, "consume")
...
class CycleCountViewSet(InventoryViewSet):
    model = CycleCount
    action_permissions = {
        "list": CYCLE_COUNT_READ,
        "retrieve": CYCLE_COUNT_READ,
        "create": CYCLE_COUNT_CREATE,
        "partial_update": CYCLE_COUNT_UPDATE,
        "start": CYCLE_COUNT_START,
        "submit": CYCLE_COUNT_SUBMIT,
        "approve": CYCLE_COUNT_APPROVE,
        "reject": CYCLE_COUNT_REJECT,
        "post": CYCLE_COUNT_POST,
        "cancel": CYCLE_COUNT_CANCEL,
    }  # noqa: F405
    action_quotas = {"post": POST_QUOTA}  # noqa: F405
    serializer_classes = {
        "list": CycleCountListSerializer,
        "retrieve": CycleCountDetailSerializer,
        "create": CycleCountCreateSerializer,
        "partial_update": CycleCountUpdateSerializer,
        "start": VersionedCommandSerializer,
        "submit": VersionedCommandSerializer,
        "approve": VersionedCommandSerializer,
        "reject": ReasonCommandSerializer,
        "post": VersionedCommandSerializer,
    ...
    def apply_filters(self, queryset: QuerySet[Any], params: Mapping[str, Any]) -> QuerySet[Any]:
        if params.get("scheduled_from"):
            queryset = queryset.filter(scheduled_for__gte=params["scheduled_from"])
        if params.get("scheduled_to"):
            queryset = queryset.filter(scheduled_for__lte=params["scheduled_to"])
        return queryset

    def create(self, request: Request) -> Response:
        serializer = CycleCountCreateSerializer(data=request.data)
        serializer.is_valid(raise_exception=True)  # noqa: F405,E702
        obj = _call(
            lambda: CycleCountService.create(
                _tenant(request), _actor(request), dict(serializer.validated_data), _idempotency_key(request)
            )
        )
    ...
    def partial_update(self, request: Request, pk: str | None = None) -> Response:
        obj = self.get_object()
        serializer = CycleCountUpdateSerializer(data=request.data, partial=True)  # noqa: F405,E702
        serializer.is_valid(raise_exception=True)
        command = dict(serializer.validated_data)  # noqa: E702
        result = _call(
            lambda: CycleCountService.update_scheduled(
                _tenant(request), obj.id, _expected_version(request, command), _actor(request), command
            )
        )
    ...
    def _transition(self, request: Request, method: str) -> Response:
        ...
        serializer.is_valid(raise_exception=True)
        result = _call(
            lambda: getattr(CycleCountService, method)(
                _tenant(request), obj.id, _actor(request), _idempotency_key(request)
            )
        )
        return Response(CycleCountDetailSerializer(result).data)  # noqa: F405
    ...
    @action(detail=True, methods=["post"])
    def post(self, request: Request, pk: str | None = None) -> Response:
        return self._transition(request, "post_adjustment")
...
class ConfigurationViewSet(InventoryViewSet):
    ...
    action_permissions = {
        ...
        "partial_update": CONFIGURATION_UPDATE,
        "preview": CONFIGURATION_PREVIEW,
        "activate": CONFIGURATION_ACTIVATE,
        "rollback": CONFIGURATION_ROLLBACK,
        "import_document": CONFIGURATION_IMPORT,
        "export_document": CONFIGURATION_EXPORT,
        "history": CONFIGURATION_AUDIT,
    }  # noqa: F405
    serializer_classes = {
        "list": ConfigurationListSerializer,
        "retrieve": ConfigurationDetailSerializer,
        "partial_update": ConfigurationUpdateSerializer,
        "preview": ConfigurationPreviewSerializer,
        "activate": ConfigurationActivateSerializer,
        "rollback": ConfigurationRollbackSerializer,
        "import_document": ConfigurationImportSerializer,
        "export_document": ConfigurationDetailSerializer,
        "history": ConfigurationRevisionSerializer,
    }  # noqa: F405
    ...
    def get_object(self) -> Any:
        ...
        if not environment:
            raise NotFound("The requested inventory configuration was not found.")
        try:
            configuration = InventoryConfiguration.objects.for_tenant(_tenant(self.request)).get(
    ...
    def partial_update(self, request: Request, environment: str | None = None) -> Response:
        ...
        values.pop("environment", None)  # noqa: E702
...
class ImportViewSet(GovernedAPIViewMixin, InventoryAccessMixin, viewsets.ViewSet):  # type: ignore[misc]
    ...
    def create(self, request: Request) -> Response:
        ...
        job = _call(
            lambda: InventoryBulkService.enqueue_import(
                _tenant(request),
                _actor(request),
