"""
PerformanceMonitoring Models.

Defines data models for PerformanceMonitoring module.
...
class PerformanceMonitoringResource(TenantBaseModel):
    """Primary resource model for PerformanceMonitoring module.
