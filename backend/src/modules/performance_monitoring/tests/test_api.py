...
class TestTenantBaseModelViewSet:
    ...
    def test_list_resources(self, authenticated_client, tenant_user):
        ...
        response = authenticated_client.get("/api/v1/performance-monitoring/resources/")
        assert response.status_code == status.HTTP_200_OK
    ...
    def test_get_resource_detail(self, authenticated_client, tenant_user):
        ...
        response = authenticated_client.get(f"/api/v1/performance-monitoring/resources/{resource.id}/")  # noqa: F541
        assert response.status_code == status.HTTP_200_OK
    ...
    def test_delete_resource(self, authenticated_client, tenant_user):
        ...
        response = authenticated_client.delete(f"/api/v1/performance-monitoring/resources/{resource.id}/")  # noqa: F541
