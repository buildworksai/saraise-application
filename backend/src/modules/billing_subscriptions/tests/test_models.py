"""
Model Unit Tests for BillingSubscriptions module.
...
class TestBillingSubscriptionsResourceModel:
    """Test BillingSubscriptionsResource model."""
    ...
    def test_resource_has_tenant_id(self, db):
        ...
        resource = BillingSubscriptionsResource(
            name="Test Resource",
            created_by="user-123",
        )
