"""
Service Unit Tests for BillingSubscriptions module.
...
from src.modules.billing_subscriptions.services import BillingSubscriptionsService


@pytest.mark.django_db
class TestBillingSubscriptionsService:
    """Test BillingSubscriptionsService business logic."""

    def test_create_resource(self, db):
        """Test creating a resource via service."""
        service = BillingSubscriptionsService()
