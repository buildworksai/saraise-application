...
class TestTenantIsolation:
    ...
    def test_user_cannot_list_other_tenant_settings(self, api_client, tenant_a_user, tenant_b_user):
        ...
        setting_a = PlatformSetting.objects.create(tenant_id=tenant_a_id, key="tenant_a_setting", value="a_value")

        # Create setting for tenant B
        setting_b = PlatformSetting.objects.create(tenant_id=tenant_b_id, key="tenant_b_setting", value="b_value")
    ...
    def test_user_cannot_access_other_tenant_setting(self, api_client, tenant_a_user, tenant_b_user):
        ...
        # Create setting for tenant B
        other_setting = PlatformSetting.objects.create(tenant_id=tenant_b_id, key="other_setting", value="other_value")
    ...
    def test_user_cannot_update_other_tenant_setting(self, api_client, tenant_a_user, tenant_b_user):
        ...
        other_setting = PlatformSetting.objects.create(
            tenant_id=tenant_b_id, key="other_setting", value="original_value"
        )
    ...
    def test_user_cannot_delete_other_tenant_setting(self, api_client, tenant_a_user, tenant_b_user):
        ...
        response = api_client.delete(f"/api/v1/platform/settings/{other_setting.id}/")
    ...
    def test_feature_flag_tenant_isolation(self, api_client, tenant_a_user, tenant_b_user):
        ...
        other_flag = FeatureFlag.objects.create(tenant_id=tenant_b_id, name="other_feature", enabled=True)

        # Login as tenant A
        api_client.force_authenticate(user=tenant_a_user)

        # Try to toggle other tenant's flag
        response = api_client.post(f"/api/v1/platform/feature-flags/{other_flag.id}/toggle/")
