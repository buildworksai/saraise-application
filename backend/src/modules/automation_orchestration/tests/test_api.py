...
class TestAutomationOrchestrationResourceViewSet:
    """Test AutomationOrchestrationResourceViewSet CRUD operations."""
    ...
    def test_list_resources(self, authenticated_client, tenant_user):
        ...
        AutomationOrchestrationResource.objects.create(
            tenant_id=tenant_id,
