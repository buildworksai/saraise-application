"""
Model Unit Tests for AutomationOrchestration module.
...
class TestAutomationOrchestrationResourceModel:
    """Test AutomationOrchestrationResource model."""
    ...
    def test_resource_has_tenant_id(self, db):
        ...
        resource = AutomationOrchestrationResource(
            name="Test Resource",
            created_by="user-123",
        )
