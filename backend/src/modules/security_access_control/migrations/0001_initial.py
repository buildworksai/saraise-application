    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(fields=["tenant_id"], name="security_se_tenant__8609b3_idx"),
                    models.Index(fields=["profile_type"], name="security_se_profile_1b8a9a_idx"),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(fields=["decision"], name="security_au_decisio_60de10_idx"),
                ],
            },
        ),
        migrations.CreateModel(
        ...
        migrations.AddIndex(
            model_name="role",
            index=models.Index(fields=["tenant_id", "is_active"], name="security_ro_tenant__6d1016_idx"),
        ),
        migrations.AddIndex(
            model_name="role",
            index=models.Index(fields=["parent_role_id"], name="security_ro_parent__d0d08c_idx"),
        ),
        migrations.AddIndex(
            model_name="role",
            index=models.Index(fields=["role_type"], name="security_ro_role_ty_a81620_idx"),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=["tenant_id"], name="security_pe_tenant__ac1166_idx"),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name="userpermissionset",
            index=models.Index(fields=["expires_at"], name="security_us_expires_5a92ec_idx"),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name="rowsecurityrule",
            index=models.Index(fields=["priority"], name="security_ro_priorit_ce5387_idx"),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name="rolepermission",
            index=models.Index(fields=["permission"], name="security_ro_permiss_b50b52_idx"),
        ),
        migrations.AlterUniqueTogether(
            name="rolepermission",
