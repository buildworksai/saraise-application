...
def add_tenant_relationship_constraints(apps, schema_editor):
    ...
    with schema_editor.connection.cursor() as cursor:
        cursor.execute('ALTER TABLE "async_jobs" ADD CONSTRAINT "asyncjob_tenant_id_uniq" UNIQUE ("tenant_id", "id")')
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=("tenant_id", "id"), name="bi_query_tenant_id_uniq"),
        ),
        migrations.AddConstraint(
            model_name="querydefinition",
            constraint=models.UniqueConstraint(
                fields=("tenant_id", "query_code"), condition=Q(deleted_at__isnull=True), name="bi_query_live_code_uniq"
            ),
        ),
        migrations.AddConstraint(
            model_name="querydefinition",
            constraint=models.CheckConstraint(
                condition=Q(row_limit__gte=1) & Q(row_limit__lte=10000), name="bi_query_row_limit_ck"
            ),
        ),
        migrations.AddConstraint(
            model_name="querydefinition",
            constraint=models.CheckConstraint(
                condition=Q(cache_ttl_seconds__gte=0) & Q(cache_ttl_seconds__lte=86400), name="bi_query_cache_ttl_ck"
            ),
        ),
        migrations.AddIndex(
            model_name="querydefinition",
            index=models.Index(fields=("tenant_id", "state", "updated_at"), name="bi_query_tenant_state_idx"),
        ),
        migrations.AddIndex(
            model_name="querydefinition",
            index=models.Index(fields=("tenant_id", "dataset_key", "state"), name="bi_query_tenant_data_idx"),
        ),
        migrations.AddIndex(
            model_name="querydefinition",
            index=models.Index(fields=("tenant_id", "deleted_at", "query_code"), name="bi_query_tenant_del_idx"),
        ),
        migrations.AddConstraint(
            model_name="report",
            constraint=models.UniqueConstraint(fields=("tenant_id", "id"), name="bi_report_tenant_id_uniq"),
        ),
        migrations.AddConstraint(
            model_name="report",
            constraint=models.UniqueConstraint(
        ...
        migrations.AddConstraint(
            model_name="report",
            constraint=models.CheckConstraint(
                condition=~Q(state="published") | (Q(query_definition__isnull=False) & Q(legacy_query="")),
                name="bi_report_published_query_ck",
            ),
        ),
        migrations.AddIndex(
            model_name="report",
            index=models.Index(fields=("tenant_id", "report_type", "state"), name="bi_report_tenant_type_idx"),
        ),
        migrations.AddIndex(
            model_name="report",
            index=models.Index(fields=("tenant_id", "query_definition"), name="bi_report_tenant_query_idx"),
        ),
        migrations.AddIndex(
            model_name="report", index=models.Index(fields=("tenant_id", "updated_at"), name="bi_report_tenant_upd_idx")
        ),
        migrations.AddConstraint(
            model_name="dashboard",
            constraint=models.UniqueConstraint(fields=("tenant_id", "id"), name="bi_dash_tenant_id_uniq"),
        ),
        migrations.AddConstraint(
            model_name="dashboard",
            constraint=models.UniqueConstraint(
        ...
        migrations.AddConstraint(
            model_name="dashboard",
            constraint=models.CheckConstraint(
                condition=Q(refresh_interval_seconds__isnull=True)
                | (Q(refresh_interval_seconds__gte=30) & Q(refresh_interval_seconds__lte=86400)),
                name="bi_dash_refresh_ck",
            ),
        ),
        migrations.AddIndex(
            model_name="dashboard",
            index=models.Index(fields=("tenant_id", "state", "updated_at"), name="bi_dash_tenant_state_idx"),
        ),
        migrations.AddIndex(
            model_name="dashboard",
            index=models.Index(fields=("tenant_id", "deleted_at", "dashboard_code"), name="bi_dash_tenant_del_idx"),
        ),
        migrations.AddConstraint(
            model_name="dashboardwidget",
            constraint=models.CheckConstraint(
                condition=(Q(query_definition__isnull=False) & Q(report__isnull=True))
        ...
        migrations.AddConstraint(
            model_name="dashboardwidget",
            constraint=models.CheckConstraint(condition=Q(width__gte=1) & Q(width__lte=12), name="bi_widget_width_ck"),
        ),
        migrations.AddConstraint(
            model_name="dashboardwidget",
            constraint=models.CheckConstraint(
                condition=Q(height__gte=1) & Q(height__lte=24), name="bi_widget_height_ck"
            ),
        ),
        migrations.AddConstraint(
            model_name="dashboardwidget",
        ...
        migrations.AddConstraint(
            model_name="dashboardwidget",
            constraint=models.CheckConstraint(condition=Q(x__gte=0), name="bi_widget_x_ck"),
        ),
        migrations.AddConstraint(
            model_name="dashboardwidget",
            constraint=models.CheckConstraint(condition=Q(y__gte=0), name="bi_widget_y_ck"),
        ),
        migrations.AddConstraint(
            model_name="dashboardwidget",
            constraint=models.UniqueConstraint(
        ...
        migrations.AddIndex(
            model_name="dashboardwidget",
            index=models.Index(fields=("tenant_id", "dashboard", "display_order"), name="bi_widget_tenant_dash_idx"),
        ),
        migrations.AddIndex(
            model_name="dashboardwidget",
            index=models.Index(fields=("tenant_id", "query_definition"), name="bi_widget_tenant_query_idx"),
        ),
        migrations.AddIndex(
            model_name="dashboardwidget",
            index=models.Index(fields=("tenant_id", "report"), name="bi_widget_tenant_report_idx"),
        ),
        migrations.AddConstraint(
            model_name="dashboardshare",
            constraint=models.UniqueConstraint(
        ...
        migrations.AddIndex(
            model_name="dashboardshare",
            index=models.Index(
                fields=("tenant_id", "subject_type", "subject_id", "revoked_at"), name="bi_share_tenant_subj_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="dashboardshare",
            index=models.Index(fields=("tenant_id", "dashboard", "revoked_at"), name="bi_share_tenant_dash_idx"),
        ),
        migrations.AddConstraint(
            model_name="queryexecution",
            constraint=models.UniqueConstraint(
                fields=("tenant_id", "idempotency_key"), name="bi_execution_tenant_idem_uniq"
            ),
        ),
        migrations.AddConstraint(
            model_name="queryexecution",
            constraint=models.CheckConstraint(
                condition=~Q(status="failed") | Q(result_rows=[]), name="bi_execution_failed_empty_ck"
            ),
        ),
        migrations.AddConstraint(
            model_name="queryexecution",
            constraint=models.CheckConstraint(
                condition=~Q(status="succeeded") | Q(row_count__isnull=False), name="bi_execution_success_count_ck"
            ),
        ),
        migrations.AddIndex(
            model_name="queryexecution",
            index=models.Index(fields=("tenant_id", "status", "created_at"), name="bi_exec_tenant_status_idx"),
        ),
        migrations.AddIndex(
            model_name="queryexecution",
            index=models.Index(fields=("tenant_id", "query_definition", "created_at"), name="bi_exec_tenant_query_idx"),
        ),
        migrations.AddIndex(
            model_name="queryexecution",
            index=models.Index(fields=("tenant_id", "report", "created_at"), name="bi_exec_tenant_report_idx"),
        ),
        migrations.AddIndex(
            model_name="queryexecution",
            index=models.Index(fields=("tenant_id", "dashboard", "created_at"), name="bi_exec_tenant_dash_idx"),
        ),
