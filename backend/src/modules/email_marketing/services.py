...
class EmailCampaignService:
    ...
    @staticmethod
    def create_campaign(
        tenant_id: str, campaign_code: str, campaign_name: str, subject: str, **kwargs
    ) -> EmailCampaign:
...
class EmailTemplateService:
    ...
    @staticmethod
    def create_template(
        tenant_id: str, template_code: str, template_name: str, subject: str, body_html: str, **kwargs
    ) -> EmailTemplate:
