...
class TestApiManagementResourceViewSet:
    """Test ApiManagementResourceViewSet CRUD operations."""
    ...
    def test_list_resources(self, authenticated_client, tenant_user):
        ...
        ApiManagementResource.objects.create(
            tenant_id=tenant_id,
        ...
        response = authenticated_client.get(f"/api/v1/api-management/resources/")
        assert response.status_code == status.HTTP_200_OK
    ...
    def test_create_resource(self, authenticated_client, tenant_user):
        ...
        response = authenticated_client.post(
            f"/api/v1/api-management/resources/",
            data,
            format="json"
        )
    ...
    def test_update_resource(self, authenticated_client, tenant_user):
        ...
        response = authenticated_client.put(
            f"/api/v1/api-management/resources/{resource.id}/",
            data,
            format="json"
        )
        assert response.status_code == status.HTTP_200_OK
