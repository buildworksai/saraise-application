...
class TestApiManagementTenantIsolation:
    """
    CRITICAL: Tenant isolation tests for ApiManagementResource model.
    ...
    def test_user_cannot_list_other_tenant_resources(self, api_client, tenant_a_user, tenant_b_user):
        ...
        resource_a = ApiManagementResource.objects.create(
        ...
        resource_b = ApiManagementResource.objects.create(
    ...
    def test_user_cannot_delete_other_tenant_resource(self, api_client, tenant_a_user, tenant_b_user):
        ...
        assert ApiManagementResource.objects.filter(id=resource_b.id).exists()
