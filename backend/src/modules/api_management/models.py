"""
ApiManagement Models.

Defines data models for ApiManagement module.
...
class ApiManagementResource(TenantBaseModel):
    """Primary resource model for ApiManagement module.
