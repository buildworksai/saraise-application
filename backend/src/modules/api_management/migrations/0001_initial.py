    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(fields=["tenant_id", "is_active"], name="api_managem_tenant__333053_idx"),
                    models.Index(fields=["tenant_id", "name"], name="api_managem_tenant__099503_idx"),
                ],
            },
        ),
    ]
