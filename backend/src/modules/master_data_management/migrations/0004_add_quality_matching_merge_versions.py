    ...
    operations = [
            ...
            options={
                ...
                "constraints": [
                    models.UniqueConstraint(
                        fields=("tenant_id", "entity", "version_number"), name="mdm_version_entity_number_uniq"
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("version_number__gte", 1)), name="mdm_version_number_gte_1_ck"
                    ),
                    models.CheckConstraint(
                        condition=models.Q(
                            ("quality_score_snapshot__gte", decimal.Decimal("0.00")),
                            ("quality_score_snapshot__lte", decimal.Decimal("100.00")),
                        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("field_path", models.CharField(blank=True, default="", max_length=255)),
                (
                    "rule_type",
                    models.CharField(
                        choices=[
                ...
                ("dimension", models.CharField(choices=DIMENSIONS, max_length=20)),
            ...
            options={
                ...
                "constraints": [
                    ...
                    models.CheckConstraint(
                        condition=models.Q(("weight__gt", 0)), name="mdm_quality_rule_weight_gt_0_ck"
                    ),
                ],
                "indexes": [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("resolved_by", models.UUIDField(blank=True, editable=False, null=True)),
            ...
            options={
                ...
                "constraints": [
                    models.UniqueConstraint(
                        condition=models.Q(("rule__isnull", False), ("status", "open")),
                        fields=("tenant_id", "entity", "rule", "field_path"),
                        name="mdm_issue_open_rule_field_uniq",
                    ),
                    models.UniqueConstraint(
                        condition=models.Q(("rule__isnull", True), ("status", "open")),
                ...
                "indexes": [
                    models.Index(
                        fields=["tenant_id", "status", "severity", "created_at"], name="mdm_issue_status_severity_idx"
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("blocking_fields", models.JSONField(blank=True, default=list)),
                ("review_threshold", models.DecimalField(decimal_places=4, max_digits=5)),
                ("auto_confirm_threshold", models.DecimalField(decimal_places=4, max_digits=5)),
                ("is_active", models.BooleanField(default=True)),
                (
                    "entity_type",
                    models.ForeignKey(
            ...
            options={
                ...
                "constraints": [
                    ...
                    models.CheckConstraint(
                        condition=models.Q(("review_threshold__gte", 0), ("review_threshold__lte", 1)),
                        name="mdm_match_review_threshold_ck",
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("auto_confirm_threshold__gte", 0), ("auto_confirm_threshold__lte", 1)),
                        name="mdm_match_confirm_threshold_ck",
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("review_threshold__lte", models.F("auto_confirm_threshold"))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("reversed_by", models.UUIDField(blank=True, editable=False, null=True)),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["tenant_id", "golden_record", "-created_at"], name="mdm_merge_golden_created_idx"
                    ),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "constraints": [
                    models.CheckConstraint(
                        condition=models.Q(("left_entity_id__lt", models.F("right_entity_id"))),
                    ...
                    models.CheckConstraint(
                        condition=(
                            models.Q(
                                ("reviewed_at__isnull", True), ("reviewed_by__isnull", True), ("status", "pending")
                            )
                            | models.Q(
                                ("reviewed_at__isnull", False),
                                ("reviewed_by__isnull", False),
                                ("status__in", ("confirmed", "rejected", "merged")),
                            )
                        ),
                        name="mdm_candidate_review_state_ck",
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("merge_history__isnull", False), ("status", "merged"))
                        | ~models.Q(("status", "merged")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "role",
                    models.CharField(
                        choices=[("survivor", "Survivor"), ("merged_source", "Merged source")], max_length=16
                    ),
                ),
                (
                    "merge_history",
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="merge_participations",
                        to="master_data_management.masterdataentity",
                    ),
                ),
            ],
            options={
                ...
                "constraints": [
                    models.UniqueConstraint(
                        fields=("tenant_id", "merge_history", "source_entity"), name="mdm_participant_source_uniq"
                    ),
                    models.UniqueConstraint(
                        condition=models.Q(("role", "survivor")),
                        fields=("tenant_id", "merge_history"),
                        name="mdm_participant_one_survivor_uniq",
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("source_version__gte", 1)), name="mdm_participant_version_gte_1_ck"
                    ),
                ],
                "indexes": [
                    models.Index(
                        fields=["tenant_id", "source_entity", "-created_at"], name="mdm_participant_source_idx"
                    )
                ],
            },
        ),
