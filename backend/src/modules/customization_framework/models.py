"""
CustomizationFramework Models.

Defines data models for CustomizationFramework module.
...
class TenantBaseModel(models.Model):
    ...
    class Meta:
        app_label = "customization_framework"
        abstract = True
        indexes = [
...
class CustomizationFrameworkResource(TenantBaseModel):
    """Primary resource model for CustomizationFramework module.
    ...
    class Meta:
        app_label = "customization_framework"
        db_table = "customization_framework_resources"
        indexes = [
