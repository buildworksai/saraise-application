"""
Model Unit Tests for CustomizationFramework module.
...
class TestCustomizationFrameworkResourceModel:
    """Test CustomizationFrameworkResource model."""
    ...
    def test_resource_has_tenant_id(self, db):
        ...
        resource = CustomizationFrameworkResource(
            name="Test Resource",
            created_by="user-123",
        )
