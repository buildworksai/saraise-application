...
MODEL_GROUPS = [
    ...
    {"name": "tool", "models": ["Tool", "ToolInvocation"], "migration_num": 2, "description": "Tool models"},
    {"name": "approval", "models": ["ApprovalRequest"], "migration_num": 3, "description": "Approval models"},
    {
        "name": "sod",
    ...
    {"name": "quota", "models": ["TenantQuota", "QuotaUsage"], "migration_num": 5, "description": "Quota models"},
    {
        "name": "cost",
    ...
    {"name": "audit", "models": ["AuditEvent", "AuditTrail"], "migration_num": 7, "description": "Audit models"},
    {
        "name": "egress",
...
def create_migration_file(group, operations, migration_number, dependency_number):
    ...
    if migration_number == 1:
        ...
        dependency = (
            'dependencies = [\n        ("ai_agent_management", '
            f'"{dependency_number:04d}_create_{prev_group["name"]}"),\n    ]'
        )
        is_initial = False
...
def main():
    ...
    print("Plus 1 migration for indexes")
    print()
    ...
    for group in MODEL_GROUPS:
        ...
        file_name, file_content = create_migration_file(group, operations, migration_number, dependency_number)
