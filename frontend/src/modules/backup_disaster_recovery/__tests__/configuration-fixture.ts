...
export const configurationFixture: BackupDisasterRecoveryConfiguration = {
  ...
  document: {
    ...
    resilience: {
      ...
      checksum_chunk_bytes: 1048576,
    },
    health: {
      probe_timeout_seconds: 2,
      probe_timeout_max_seconds: 10,
      provider_stale_seconds: 30,
      outbox_max_lag_seconds: 60,
      exercise_freshness_seconds: 86400,
      registry_staleness_seconds: 30,
      exercise_registry_staleness_seconds: 86400,
    ...
    runbooks: {
      default_rpo_seconds: 3600,
      default_rto_seconds: 14400,
      objective_min_seconds: 1,
      objective_max_seconds: 315360000,
      min_publish_steps: 1,
    ...
    exercises: {
      production_enabled: false,
      default_schedule_offset_ms: 3600000,
    ...
    reports: {
      ...
      max_results: 1000,
      compliant_percent: 100,
      noncompliant_percent: 0,
    },
    presentation: {
      duration_minute_seconds: 60,
      duration_hour_seconds: 3600,
      byte_base: 1024,
