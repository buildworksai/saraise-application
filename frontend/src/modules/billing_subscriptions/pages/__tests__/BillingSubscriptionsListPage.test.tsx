...
describe('BillingSubscriptionsListPage', () => {
  ...
  it('should render loading state', () => {
    vi.mocked(billing_subscriptions_service.listResources).mockImplementation(
  ...
  it('should render empty state when no resources', async () => {
    vi.mocked(billing_subscriptions_service.listResources).mockResolvedValue([]);
  ...
  it('should render resources list', async () => {
    ...
    vi.mocked(billing_subscriptions_service.listResources).mockResolvedValue(mockResources as any);
