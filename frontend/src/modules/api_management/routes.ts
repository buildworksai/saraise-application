...
export const tenantRoutes = [
  {
    ...
    Page: lazy(() =>
      import("./pages/ApiManagementListPage").then(({ ApiManagementListPage }) => ({
        default: ApiManagementListPage,
      }))
    ),
    navigation: {
      type: "sidebar",
  ...
  },
  {
    ...
    Page: lazy(() =>
      import("./pages/CreateApiManagementResourcePage").then(
        ({ CreateApiManagementResourcePage }) => ({ default: CreateApiManagementResourcePage })
      )
    ),
    navigation: {
      type: "sidebar",
  ...
  },
  {
    ...
    Page: lazy(() =>
      import("./pages/ApiManagementDetailPage").then(({ ApiManagementDetailPage }) => ({
        default: ApiManagementDetailPage,
      }))
    ),
    navigation: {
      type: "sidebar",
      label: "Open resource",
      icon: FileSearch,
      runtimeOrderKey: "resources_detail",
      path: ROUTES.RESOURCES,
    },
  },
  {
    ...
    Page: lazy(() =>
      import("./pages/ApiManagementConfigurationPage").then(
        ({ ApiManagementConfigurationPage }) => ({ default: ApiManagementConfigurationPage })
      )
    ),
    navigation: {
      type: "sidebar",
