...
describe("ApiManagementDetailPage", () => {
  ...
  it("renders complete resource details", async () => {
    vi.mocked(api_managementService.getResource).mockResolvedValue(
      resource({ name: "Test resource", description: "Test description", config: { key: "value" } })
    );
    renderPage();
