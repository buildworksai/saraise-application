/**
 * IntegrationPlatformListPage Component Tests
 */
...
import { IntegrationPlatformListPage } from './IntegrationPlatformListPage';
...
describe('IntegrationPlatformListPage', () => {
  ...
  it('should render loading state', () => {
    vi.mocked(integration_platform_service.listResources).mockImplementation(
  ...
  it('should render empty state when no resources', async () => {
    vi.mocked(integration_platform_service.listResources).mockResolvedValue([]);
  ...
  it('should render resources list', async () => {
    ...
    vi.mocked(integration_platform_service.listResources).mockResolvedValue(mockResources as any);
