...
describe("master data governed UX", () => {
  ...
  ] as const)("renders distinct %s state", (status, label) => {
    render(
      <GovernedError error={new ApiError("request failed", status, undefined, "CODE", "corr-1")} />
    );
  ...
  it("announces geometry-matched loading and an actionable empty state", () => {
    ...
    rerender(
      <EmptyState
        ...
        description="Nothing requires stewardship."
