...
import { ConfirmAction, Detail, DetailGrid, GovernedError, MutationNotice, PageHeader, PageSkeleton, QUERY_KEYS, StatusPill, Surface } from "../components/MdmUI";
...
export function MatchingRuleDetailPage() {
  ...
  const remove = useMutation({ mutationFn: () => masterDataService.matchingRules.delete(id), onSuccess: () => navigate(ROUTES.MATCHING_RULES) });
