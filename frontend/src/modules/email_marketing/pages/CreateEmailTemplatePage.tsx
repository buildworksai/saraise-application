...
export function CreateEmailTemplatePage() {
  ...
  const mutation = useMutation({
    mutationFn: emailMarketingService.templates.create,
  ...
  return (
    <Page
      ...
      description="Sanitized HTML, a plain-text alternative, and versioned design data create portable campaign content."
