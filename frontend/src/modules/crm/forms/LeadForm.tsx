...
import type { Lead, LeadCreate } from "../contracts";
import { Field, LiveRegion, SubmitButton, fieldClass } from "../components/CrmPage";
...
export function LeadForm({
  ...
  onSubmit: (payload: LeadCreate) => Promise<void>;
  submitLabel?: string;
}) {
  ...
  async function submit(event: React.FormEvent<HTMLFormElement>) {
    ...
    if (!value(data, "last_name")) next.last_name = "Last name is required.";
    ...
    >
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <Field id="source" label="Source">
          <input id="source" name="source" defaultValue={initial?.source} className={fieldClass} />
        </Field>
