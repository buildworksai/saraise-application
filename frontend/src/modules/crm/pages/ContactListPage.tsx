...
export function ContactListPage() {
  ...
  const filters: ContactFilters = {
    ...
    engagement_min: p.get("engagement_min") ? Number(p.get("engagement_min")) : undefined,
  ...
  if (configuration.isLoading)
    return (
      <CrmPage title="Contacts">
        <PageSkeleton label="Loading contact configuration" />
      </CrmPage>
    );
  ...
  return (
    <EntityList
      title="Contacts"
      description="See the people, relationships, and engagement evidence behind every deal."
      createPath="/crm/contacts/new"
      emptyTitle="Create your first contact"
      emptyDescription="Add a contact to an existing account to begin tracking engagement."
      query={q.data}
      ...
      filters={[
        ...
        {
          key: "engagement_min",
          label: `Minimum engagement (${document.contact.engagement_score_min}-${document.contact.engagement_score_max})`,
        },
      ]}
      columns={[
        {
        ...
        { key: "title", label: "Title", render: (contact) => contact.title || "—" },
        {
          key: "engagement_score",
          label: "Engagement",
          sortable: true,
          render: (contact) => String(contact.engagement_score),
        },
        {
