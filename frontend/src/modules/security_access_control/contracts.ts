...
export interface ReplacePermissionSetPermissionsInput {
  readonly permission_ids: readonly UUID[];
}
...
export interface PredicateSubjectReference {
...
export type RowPredicate =
  ...
  | {
      readonly op: "eq";
      readonly field: string;
      readonly value: PredicateValue | PredicateSubjectReference;
    }
...
export type SecuritySemanticToken =
  | "status-success"
  | "status-danger"
  | "status-warning"
  | "status-neutral";
...
export interface SecurityConfigurationDocument {
  ...
  readonly ui: {
    readonly loading_skeleton_rows: number;
    readonly audit_timeline_page_size: number;
  };
  ...
  readonly baseline_profile: Omit<
    SecurityProfileDefaults,
    "profile_type" | "time_restrictions" | "login_notification" | "access_notification"
  > & {
    readonly ip_whitelist: readonly string[];
    readonly ip_blacklist: readonly string[];
    readonly allowed_countries: readonly string[];
...
export interface SecurityConfigurationWriteInput {
  readonly document: SecurityConfigurationDocument;
  readonly environment: string;
  readonly reason: string;
  readonly rollout?: SecurityConfigurationRollout;
}
export interface SecurityConfigurationPreviewInput {
  readonly document: SecurityConfigurationDocument;
  readonly rollout?: SecurityConfigurationRollout;
}
...
export interface SecurityConfigurationRollbackInput {
  readonly reason: string;
}
export interface SecurityConfigurationRolloutInput {
  readonly rollout: SecurityConfigurationRollout;
  readonly reason: string;
}
export interface DeletionReasonInput {
  readonly reason: string;
}
...
export interface RoleFilters extends PageFilters {
  readonly role_type?: RoleType;
  readonly is_active?: boolean;
  readonly parent_role_id?: UUID;
}
export interface PermissionFilters extends PageFilters {
  readonly module?: string;
  readonly resource?: string;
  readonly action?: string;
  readonly risk_level?: RiskLevel;
}
export interface AssignmentFilters extends PageFilters {
  readonly user_id?: UUID;
  readonly role_id?: UUID;
  readonly permission_set_id?: UUID;
  readonly profile_id?: UUID;
  readonly active_at?: ISODateTime;
  readonly revoked?: boolean;
}
export interface PermissionSetFilters extends PageFilters {
  readonly is_active?: boolean;
}
export interface FieldSecurityFilters extends PageFilters {
  readonly module?: string;
  readonly resource?: string;
  readonly field?: string;
  readonly role_id?: UUID;
...
export interface RowSecurityFilters extends PageFilters {
  readonly module?: string;
  readonly resource?: string;
  readonly role_id?: UUID;
  readonly rule_type?: RuleType;
...
export interface SecurityProfileFilters extends PageFilters {
  readonly profile_type?: ProfileType;
  readonly mfa_required?: MfaRequired;
  readonly is_active?: boolean;
}
export interface AuditLogFilters extends PageFilters {
...
export const ENDPOINTS = {
  ROLES: {
    LIST: `${API_ROOT}/roles/`,
    CREATE: `${API_ROOT}/roles/`,
    DETAIL: (id: UUID) => `${API_ROOT}/roles/${id}/` as const,
    UPDATE: (id: UUID) => `${API_ROOT}/roles/${id}/` as const,
    DELETE: (id: UUID) => `${API_ROOT}/roles/${id}/` as const,
    PERMISSIONS: (id: UUID) => `${API_ROOT}/roles/${id}/permissions/` as const,
    PERMISSION: (id: UUID, permissionId: UUID) =>
      `${API_ROOT}/roles/${id}/permissions/${permissionId}/` as const,
  },
  PERMISSIONS: {
    LIST: `${API_ROOT}/permissions/`,
    DETAIL: (id: UUID) => `${API_ROOT}/permissions/${id}/` as const,
  },
  USER_ROLES: {
    LIST: `${API_ROOT}/user-roles/`,
    CREATE: `${API_ROOT}/user-roles/`,
    DETAIL: (id: UUID) => `${API_ROOT}/user-roles/${id}/` as const,
    UPDATE: (id: UUID) => `${API_ROOT}/user-roles/${id}/` as const,
    DELETE: (id: UUID) => `${API_ROOT}/user-roles/${id}/` as const,
  },
  PERMISSION_SETS: {
    LIST: `${API_ROOT}/permission-sets/`,
    CREATE: `${API_ROOT}/permission-sets/`,
    DETAIL: (id: UUID) => `${API_ROOT}/permission-sets/${id}/` as const,
    UPDATE: (id: UUID) => `${API_ROOT}/permission-sets/${id}/` as const,
    DELETE: (id: UUID) => `${API_ROOT}/permission-sets/${id}/` as const,
    PERMISSIONS: (id: UUID) => `${API_ROOT}/permission-sets/${id}/permissions/` as const,
  },
  USER_PERMISSION_SETS: {
    LIST: `${API_ROOT}/user-permission-sets/`,
    CREATE: `${API_ROOT}/user-permission-sets/`,
    DETAIL: (id: UUID) => `${API_ROOT}/user-permission-sets/${id}/` as const,
    UPDATE: (id: UUID) => `${API_ROOT}/user-permission-sets/${id}/` as const,
    DELETE: (id: UUID) => `${API_ROOT}/user-permission-sets/${id}/` as const,
  },
  FIELD_SECURITY: {
    LIST: `${API_ROOT}/field-security/`,
    CREATE: `${API_ROOT}/field-security/`,
    DETAIL: (id: UUID) => `${API_ROOT}/field-security/${id}/` as const,
    UPDATE: (id: UUID) => `${API_ROOT}/field-security/${id}/` as const,
    DELETE: (id: UUID) => `${API_ROOT}/field-security/${id}/` as const,
  },
  ROW_SECURITY: {
    LIST: `${API_ROOT}/row-security-rules/`,
    CREATE: `${API_ROOT}/row-security-rules/`,
    DETAIL: (id: UUID) => `${API_ROOT}/row-security-rules/${id}/` as const,
    UPDATE: (id: UUID) => `${API_ROOT}/row-security-rules/${id}/` as const,
    DELETE: (id: UUID) => `${API_ROOT}/row-security-rules/${id}/` as const,
  },
  SECURITY_PROFILES: {
    LIST: `${API_ROOT}/security-profiles/`,
    CREATE: `${API_ROOT}/security-profiles/`,
    DETAIL: (id: UUID) => `${API_ROOT}/security-profiles/${id}/` as const,
    UPDATE: (id: UUID) => `${API_ROOT}/security-profiles/${id}/` as const,
    DELETE: (id: UUID) => `${API_ROOT}/security-profiles/${id}/` as const,
  },
  PROFILE_ASSIGNMENTS: {
    LIST: `${API_ROOT}/security-profile-assignments/`,
    CREATE: `${API_ROOT}/security-profile-assignments/`,
    DETAIL: (id: UUID) => `${API_ROOT}/security-profile-assignments/${id}/` as const,
    UPDATE: (id: UUID) => `${API_ROOT}/security-profile-assignments/${id}/` as const,
    DELETE: (id: UUID) => `${API_ROOT}/security-profile-assignments/${id}/` as const,
  },
  AUDIT_LOGS: {
    LIST: `${API_ROOT}/audit-logs/`,
    DETAIL: (id: UUID) => `${API_ROOT}/audit-logs/${id}/` as const,
  },
  ...
  CONFIGURATION: {
    ...
    ROLLBACK: (version: number) =>
      `${API_ROOT}/configuration/versions/${version}/rollback/` as const,
...
export const ROUTES = {
  ROLES: "/security-access-control/roles",
  ROLE_CREATE: "/security-access-control/roles/create",
  ROLE_DETAIL: (id: UUID) => `/security-access-control/roles/${id}` as const,
  ROLE_EDIT: (id: UUID) => `/security-access-control/roles/${id}/edit` as const,
  PERMISSIONS: "/security-access-control/permissions",
  PERMISSION_DETAIL: (id: UUID) => `/security-access-control/permissions/${id}` as const,
  ASSIGNMENTS: "/security-access-control/assignments",
  USER_ROLE_CREATE: "/security-access-control/assignments/create",
  USER_ROLE_DETAIL: (id: UUID) => `/security-access-control/assignments/${id}` as const,
  USER_ROLE_EDIT: (id: UUID) => `/security-access-control/assignments/${id}/edit` as const,
  PERMISSION_SETS: "/security-access-control/permission-sets",
  PERMISSION_SET_CREATE: "/security-access-control/permission-sets/create",
  PERMISSION_SET_DETAIL: (id: UUID) => `/security-access-control/permission-sets/${id}` as const,
  PERMISSION_SET_EDIT: (id: UUID) => `/security-access-control/permission-sets/${id}/edit` as const,
  USER_PERMISSION_SETS: "/security-access-control/assignments/permission-set-grants",
  USER_PERMISSION_SET_CREATE: "/security-access-control/assignments/permission-set-grants/create",
  USER_PERMISSION_SET_DETAIL: (id: UUID) =>
    `/security-access-control/assignments/permission-set-grants/${id}` as const,
  USER_PERMISSION_SET_EDIT: (id: UUID) =>
    `/security-access-control/assignments/permission-set-grants/${id}/edit` as const,
  FIELD_SECURITY: "/security-access-control/field-security",
  FIELD_SECURITY_CREATE: "/security-access-control/field-security/create",
  FIELD_SECURITY_DETAIL: (id: UUID) => `/security-access-control/field-security/${id}` as const,
  FIELD_SECURITY_EDIT: (id: UUID) => `/security-access-control/field-security/${id}/edit` as const,
  ROW_SECURITY: "/security-access-control/row-security",
  ROW_SECURITY_CREATE: "/security-access-control/row-security/create",
  ROW_SECURITY_DETAIL: (id: UUID) => `/security-access-control/row-security/${id}` as const,
  ROW_SECURITY_EDIT: (id: UUID) => `/security-access-control/row-security/${id}/edit` as const,
  SECURITY_PROFILES: "/security-access-control/security-profiles",
  SECURITY_PROFILE_CREATE: "/security-access-control/security-profiles/create",
  SECURITY_PROFILE_DETAIL: (id: UUID) =>
    `/security-access-control/security-profiles/${id}` as const,
  SECURITY_PROFILE_EDIT: (id: UUID) =>
    `/security-access-control/security-profiles/${id}/edit` as const,
  PROFILE_ASSIGNMENTS: "/security-access-control/assignments/profile-assignments",
  PROFILE_ASSIGNMENT_CREATE: "/security-access-control/assignments/profile-assignments/create",
  PROFILE_ASSIGNMENT_DETAIL: (id: UUID) =>
    `/security-access-control/assignments/profile-assignments/${id}` as const,
  PROFILE_ASSIGNMENT_EDIT: (id: UUID) =>
    `/security-access-control/assignments/profile-assignments/${id}/edit` as const,
  AUDIT_LOGS: "/security-access-control/audit-logs",
  AUDIT_LOG_DETAIL: (id: UUID) => `/security-access-control/audit-logs/${id}` as const,
...
export const QUERY_KEYS = {
  ...
  roles: (filters: RoleFilters = {}) =>
    [...QUERY_KEYS.root, "roles", stableFilters(filters)] as const,
  role: (id: UUID) => [...QUERY_KEYS.root, "role", id] as const,
  permissions: (filters: PermissionFilters = {}) =>
    [...QUERY_KEYS.root, "permissions", stableFilters(filters)] as const,
  permission: (id: UUID) => [...QUERY_KEYS.root, "permission", id] as const,
  userRoles: (filters: AssignmentFilters = {}) =>
    [...QUERY_KEYS.root, "user-roles", stableFilters(filters)] as const,
  userRole: (id: UUID) => [...QUERY_KEYS.root, "user-role", id] as const,
  permissionSets: (filters: PermissionSetFilters = {}) =>
    [...QUERY_KEYS.root, "permission-sets", stableFilters(filters)] as const,
  permissionSet: (id: UUID) => [...QUERY_KEYS.root, "permission-set", id] as const,
  userPermissionSets: (filters: AssignmentFilters = {}) =>
    [...QUERY_KEYS.root, "user-permission-sets", stableFilters(filters)] as const,
  userPermissionSet: (id: UUID) => [...QUERY_KEYS.root, "user-permission-set", id] as const,
  fieldRules: (filters: FieldSecurityFilters = {}) =>
    [...QUERY_KEYS.root, "field-security", stableFilters(filters)] as const,
  fieldRule: (id: UUID) => [...QUERY_KEYS.root, "field-security", id] as const,
  rowRules: (filters: RowSecurityFilters = {}) =>
    [...QUERY_KEYS.root, "row-security", stableFilters(filters)] as const,
  rowRule: (id: UUID) => [...QUERY_KEYS.root, "row-security", id] as const,
  profiles: (filters: SecurityProfileFilters = {}) =>
    [...QUERY_KEYS.root, "profiles", stableFilters(filters)] as const,
  profile: (id: UUID) => [...QUERY_KEYS.root, "profile", id] as const,
  profileAssignments: (filters: AssignmentFilters = {}) =>
    [...QUERY_KEYS.root, "profile-assignments", stableFilters(filters)] as const,
  profileAssignment: (id: UUID) => [...QUERY_KEYS.root, "profile-assignment", id] as const,
  auditLogs: (filters: AuditLogFilters = {}) =>
    [...QUERY_KEYS.root, "audit-logs", stableFilters(filters)] as const,
...
function enumGuard<const T extends readonly string[]>(
  value: unknown,
  values: T
): value is T[number] {
...
export function isV2PageMeta(value: unknown): value is V2PageMeta {
  return (
    ...
    isNumber(value.page) &&
    isNumber(value.page_size) &&
    isNumber(value.total_pages) &&
    isBoolean(value.has_next) &&
    isBoolean(value.has_previous)
  );
}
export function isV2Meta(value: unknown): value is V2Meta {
  return (
    isRecord(value) &&
    isString(value.correlation_id) &&
    isString(value.timestamp) &&
    (value.pagination === undefined || isV2PageMeta(value.pagination))
  );
}
export function isVisibility(value: unknown): value is Visibility {
  return enumGuard(value, ["visible", "hidden", "masked", "redacted"] as const);
}
export function isEditControl(value: unknown): value is EditControl {
  return enumGuard(value, ["read_only", "editable", "required"] as const);
}
export function isPermission(value: unknown): value is Permission {
  return (
    ...
    isString(value.name) &&
    enumGuard(value.risk_level, ["low", "medium", "high", "critical"] as const)
  );
}
export function isRole(value: unknown): value is Role {
  return (
    ...
    isString(value.name) &&
    isString(value.code) &&
    enumGuard(value.role_type, ["system", "functional", "custom", "temporary"] as const) &&
    isBoolean(value.is_active) &&
    isNumber(value.hierarchy_level)
  );
}
export function isRolePermission(value: unknown): value is RolePermission {
  return (
    ...
    isString(value.permission_id) &&
    isBoolean(value.is_granted)
  );
}
export function isUserRole(value: unknown): value is UserRole {
  return (
    ...
    isString(value.role_id) &&
    isString(value.valid_from) &&
    isNullableString(value.valid_until) &&
    isBoolean(value.is_active)
  );
}
export function isPermissionSet(value: unknown): value is PermissionSet {
  return (
    hasEntityCore(value) &&
    isString(value.name) &&
    isBoolean(value.is_active) &&
    isStringArray(value.permission_ids)
  );
}
export function isUserPermissionSet(value: unknown): value is UserPermissionSet {
  return (
    hasEntityCore(value) &&
    isString(value.user_id) &&
    isString(value.permission_set_id) &&
    isString(value.expires_at) &&
    isBoolean(value.is_active)
  );
}
export function isFieldSecurity(value: unknown): value is FieldSecurity {
  return (
    hasEntityCore(value) &&
    isString(value.module) &&
    isString(value.resource) &&
    ...
    isEditControl(value.edit_control)
  );
}
...
export function isRowSecurityRule(value: unknown): value is RowSecurityRule {
  return (
    ...
    isString(value.resource) &&
    isString(value.role_id) &&
    enumGuard(value.rule_type, ["ownership", "hierarchy", "attribute", "criteria"] as const) &&
    isRowPredicate(value.filter_criteria) &&
...
export function isSecurityProfile(value: unknown): value is SecurityProfile {
  return (
    hasEntityCore(value) &&
    isString(value.name) &&
    enumGuard(value.profile_type, [
      "standard",
      "privileged",
      "restricted",
      "high_security",
    ] as const) &&
    enumGuard(value.mfa_required, [
      "always",
      "conditional",
      "sensitive_actions",
      "never",
    ] as const) &&
    isNumber(value.session_timeout_minutes) &&
    isBoolean(value.is_active)
  );
}
export function isProfileAssignment(value: unknown): value is SecurityProfileAssignment {
  return (
    hasEntityCore(value) &&
    isString(value.security_profile_id) &&
    isNullableString(value.user_id) &&
    isNullableString(value.role_id) &&
    (value.user_id === null) !== (value.role_id === null) &&
    isBoolean(value.is_active)
  );
}
export function isSecurityAuditLog(value: unknown): value is SecurityAuditLog {
  return (
    hasEntityCore(value) &&
    isString(value.action) &&
    enumGuard(value.actor_type, ["user", "system", "agent"] as const) &&
...
function isCommercialDecision(value: unknown): value is CommercialDecision {
  return isRecord(value) && isBoolean(value.required) && isBoolean(value.allowed);
}
function isFieldAccessDecision(value: unknown): value is FieldAccessDecision {
  return (
    isRecord(value) &&
    isString(value.field) &&
    isVisibility(value.visibility) &&
    isEditControl(value.edit_control) &&
    isStringArray(value.reason_codes) &&
    isStringArray(value.applied_policy_ids)
  );
}
function isRowExplanation(value: unknown): value is RowAccessExplanation {
  return (
    isRecord(value) &&
    isBoolean(value.allowed) &&
    isStringArray(value.applied_rule_ids) &&
    isStringArray(value.reason_codes) &&
...
export function isAccessDecision(value: unknown): value is AccessDecision {
  return (
    ...
    isString(value.permission_code) &&
    enumGuard(value.decision, ["allow", "deny"] as const) &&
    isStringArray(value.reason_codes) &&
    isStringArray(value.applied_policy_ids) &&
    isCommercialDecision(value.entitlement) &&
    isCommercialDecision(value.quota) &&
    Array.isArray(value.field_decisions) &&
    value.field_decisions.every(isFieldAccessDecision) &&
    (value.row_explanation === null || isRowExplanation(value.row_explanation)) &&
    isString(value.correlation_id) &&
...
export function isHealthStatus(value: unknown): value is HealthStatus {
  return (
    isRecord(value) &&
    enumGuard(value.status, ["ready", "not_ready"] as const) &&
    isString(value.correlation_id) &&
    isRecord(value.components)
  );
}
export function isSecurityConfigurationDocument(
  value: unknown
  ...
  return (
    ...
    Array.isArray(value.remote_context_keys) &&
    isRecord(value.ui) &&
    isNumber(value.ui.loading_skeleton_rows) &&
    isRecord(value.semantic_tokens) &&
    isRecord(value.commercial_controls) &&
    isRecord(value.baseline_profile) &&
    isRecord(value.feature_flags)
  );
}
export function isSecurityConfigurationRollout(
  value: unknown
): value is SecurityConfigurationRollout {
  return (
    isRecord(value) &&
    isBoolean(value.enabled) &&
    isNumber(value.percentage) &&
    isStringArray(value.role_ids) &&
    isStringArray(value.cohorts)
  );
}
export function isSecurityConfiguration(value: unknown): value is SecurityConfiguration {
  return (
    hasEntityCore(value) &&
    isString(value.environment) &&
    isNumber(value.version) &&
    isSecurityConfigurationDocument(value.document) &&
    isSecurityConfigurationRollout(value.rollout) &&
...
export function isSecurityConfigurationVersion(
  value: unknown
): value is SecurityConfigurationVersion {
  return (
    hasEntityCore(value) &&
    isNumber(value.version) &&
    isString(value.environment) &&
    (value.previous_document === null ||
      isSecurityConfigurationDocument(value.previous_document)) &&
    isSecurityConfigurationDocument(value.current_document) &&
    (value.previous_rollout === null || isSecurityConfigurationRollout(value.previous_rollout)) &&
    isSecurityConfigurationRollout(value.current_rollout) &&
    isString(value.actor_id) &&
    isString(value.correlation_id) &&
    isString(value.reason) &&
    isString(value.change_kind) &&
    isString(value.created_at)
  );
}
export function isSecurityConfigurationPreview(
  value: unknown
): value is SecurityConfigurationPreview {
  return (
    isRecord(value) &&
    isBoolean(value.valid) &&
    Array.isArray(value.diff) &&
    isSecurityConfigurationDocument(value.normalized_document) &&
    isSecurityConfigurationRollout(value.normalized_rollout)
  );
}
export function isSecurityConfigurationExport(
  value: unknown
): value is SecurityConfigurationExport {
  return (
    isRecord(value) &&
