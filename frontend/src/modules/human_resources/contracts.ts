...
export interface EmployeeFilters extends PageQuery {
  ...
  hire_date_from?: ISODate;
  hire_date_to?: ISODate;
  is_active?: boolean;
...
export interface AttendanceFilters extends PageQuery {
  ...
  attendance_date_from?: ISODate;
  attendance_date_to?: ISODate;
...
export const ENDPOINTS = {
  ...
  EMPLOYEES: {
    ...
    RETURN_FROM_LEAVE: (id: UUID) =>
      `${MODULE_API_PREFIX}/employees/${id}/return-from-leave/` as const,
  ...
  LEAVE_BALANCES: {
    LIST: `${MODULE_API_PREFIX}/leave-balances/`,
    CREATE: `${MODULE_API_PREFIX}/leave-balances/`,
...
export const ROUTES = {
  ...
  EMPLOYEES: `${MODULE_PATH}/employees`,
  EMPLOYEE_CREATE: `${MODULE_PATH}/employees/new`,
  EMPLOYEE_DETAIL: (id: UUID) => `${MODULE_PATH}/employees/${id}` as const,
  EMPLOYEE_EDIT: (id: UUID) => `${MODULE_PATH}/employees/${id}/edit` as const,
  DEPARTMENTS: `${MODULE_PATH}/departments`,
  DEPARTMENT_CREATE: `${MODULE_PATH}/departments/new`,
  ...
  ATTENDANCE: `${MODULE_PATH}/attendance`,
  ATTENDANCE_CREATE: `${MODULE_PATH}/attendance/new`,
  ...
  LEAVE: `${MODULE_PATH}/leave`,
  LEAVE_BALANCE_CREATE: `${MODULE_PATH}/leave/balances/new`,
...
export const hrKeys = {
  ...
  departments: (filters?: DepartmentFilters) =>
    ["human-resources", "departments", filters ?? {}] as const,
  department: (id: UUID) => ["human-resources", "department", id] as const,
  hierarchy: (rootId?: UUID, includeInactive?: boolean) =>
    ["human-resources", "department-tree", rootId ?? "", includeInactive ?? false] as const,
  employees: (filters?: EmployeeFilters) =>
    ["human-resources", "employees", filters ?? {}] as const,
  employee: (id: UUID) => ["human-resources", "employee", id] as const,
  reportingTree: (id: UUID, depth: number) =>
    ["human-resources", "reporting-tree", id, depth] as const,
  attendances: (filters?: AttendanceFilters) =>
    ["human-resources", "attendances", filters ?? {}] as const,
  attendance: (id: UUID) => ["human-resources", "attendance", id] as const,
  leaveBalances: (filters?: LeaveBalanceFilters) =>
    ["human-resources", "leave-balances", filters ?? {}] as const,
  leaveBalance: (id: UUID) => ["human-resources", "leave-balance", id] as const,
  leaveRequests: (filters?: LeaveRequestFilters) =>
    ["human-resources", "leave-requests", filters ?? {}] as const,
...
export function isApiPageSuccess(value: unknown): value is ApiPageSuccess<unknown> {
  ...
  return (
    object(meta) &&
    object(meta.pagination) &&
    typeof meta.pagination.count === "number" &&
    typeof meta.pagination.page === "number" &&
    typeof meta.pagination.page_size === "number"
  );
}
...
export function isLeaveBalance(value: unknown): value is LeaveBalance {
  return (
    ...
    typeof value.id === "string" &&
    typeof value.employee === "string" &&
    typeof value.leave_type === "string" &&
    typeof value.remaining_days === "string"
  );
}
export function isLeaveRequest(value: unknown): value is LeaveRequest {
  return (
    ...
    typeof value.id === "string" &&
    typeof value.employee === "string" &&
    typeof value.leave_balance === "string" &&
    typeof value.status === "string"
  );
}
