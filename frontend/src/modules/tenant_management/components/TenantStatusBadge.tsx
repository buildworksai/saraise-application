...
export const TenantStatusBadge = ({ status, className = "" }: TenantStatusBadgeProps) => {
  ...
  return (
    <span
      className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md text-xs font-medium ${config.bgColor} ${config.borderColor} border ${config.textColor} ${className}`}
    >
