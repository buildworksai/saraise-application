...
export const ENDPOINTS = {
  TENANTS: {
    ...
    RESOURCE_USAGE: (id: string) =>
      `/api/v1/tenant-management/tenants/${id}/resource_usage/` as const,
    HEALTH_SCORES: (id: string) =>
      `/api/v1/tenant-management/tenants/${id}/health_scores/` as const,
  },
  MODULES: {
