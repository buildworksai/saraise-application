/**
 * CustomizationFrameworkListPage Component Tests
 */
...
import { CustomizationFrameworkListPage } from './CustomizationFrameworkListPage';
...
describe('CustomizationFrameworkListPage', () => {
  ...
  it('should render loading state', () => {
    vi.mocked(customization_framework_service.listResources).mockImplementation(
  ...
  it('should render empty state when no resources', async () => {
    vi.mocked(customization_framework_service.listResources).mockResolvedValue([]);
  ...
  it('should render resources list', async () => {
    ...
    vi.mocked(customization_framework_service.listResources).mockResolvedValue(mockResources as any);
