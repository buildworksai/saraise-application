...
export interface APIErrorEnvelope {
  readonly error: {
    readonly code: string;
    readonly message: string;
    readonly detail?: readonly APIFieldError[];
    readonly correlation_id: UUID;
  };
}
...
export interface AgentListItem {
  ...
  readonly provider_config_id: UUID | null;
...
export interface AgentDetail extends AgentListItem {
  ...
  readonly provider_status?: Availability;
  readonly runner_status?: Availability;
...
export interface ExecuteAgentRequest {
  ...
  readonly input_metadata?: JSONObject;
  readonly idempotency_key: string;
  readonly schedule_at?: string | null;
}
export interface EvaluationStartRequest {
  readonly suite_key: string;
  readonly idempotency_key: string;
  readonly red_team?: boolean;
}

export interface AgentExecutionListItem {
  readonly id: UUID;
  readonly agent_id: UUID;
...
export interface AgentExecutionDetail extends AgentExecutionListItem {
  readonly error_message: string;
  readonly provider_config_id: UUID | null;
  readonly transition_history: readonly TransitionEvidence[];
  readonly task_definition?: JSONObject;
  readonly result?: JSONValue | null;
}
export interface TransitionExecutionRequest extends LifecycleRequest {
  readonly agent_id?: UUID;
  readonly reason?: string;
}
...
export interface ApprovalListItem {
  readonly id: UUID;
  readonly tool_id: UUID;
  readonly tool_name?: string;
  readonly agent_execution_id: UUID;
  readonly requested_by: UUID;
  readonly requested_for: UUID;
  readonly approver_id: UUID | null;
...
export interface ApprovalDetail extends ApprovalListItem {
  readonly tool_invocation_id: UUID | null;
  readonly rejection_reason: string;
  readonly transition_history: readonly TransitionEvidence[];
  readonly tool_input?: JSONObject;
  readonly sod_warning?: string | null;
  readonly audit_correlation_id?: UUID;
}
export interface ApprovalCreateRequest {
  readonly tool_id: UUID;
  readonly execution_id: UUID;
  readonly invocation_id?: UUID | null;
  readonly requested_for: UUID;
  readonly tool_input: JSONObject;
  readonly justification: string;
  readonly expires_at?: string | null;
}
export interface ApprovalDecisionRequest extends LifecycleRequest {
  readonly reason?: string;
}
...
export interface ValidationDiagnostic {
  ...
  readonly direction: "input" | "output";
  readonly issues: readonly APIFieldError[];
}
export interface ToolInvocation {
  readonly id: UUID;
  readonly tool_id: UUID;
  readonly tool_name?: string;
  readonly agent_execution_id: UUID | null;
  readonly approval_request_id: UUID | null;
  readonly status: InvocationStatus;
  readonly input_data?: JSONObject;
  readonly output_data?: JSONValue | null;
  readonly error_code: string;
  readonly error_message: string;
...
export interface SoDPolicy {
  ...
  readonly name: string;
  readonly description: string;
  readonly action_1: string;
  readonly action_2: string;
  readonly is_active: boolean;
  readonly created_at: string;
  readonly updated_at: string;
}
...
export interface SoDPolicyUpdateRequest {
  readonly name?: string;
  readonly description?: string;
  readonly action_1?: string;
  readonly action_2?: string;
...
export interface SoDViolation {
  ...
  readonly agent_execution_id: UUID | null;
  readonly tool_invocation_id: UUID | null;
  readonly action_1_user: UUID;
  readonly action_2_user: UUID;
...
export interface EgressRule {
  ...
  readonly name: string;
  readonly description: string;
  readonly destination_type: "domain" | "ip" | "cidr" | "url_pattern";
...
export interface EgressRuleRequest {
  readonly name: string;
  readonly description?: string;
  readonly destination_type: EgressRule["destination_type"];
  readonly destination: string;
  readonly port?: number | null;
  readonly protocol: EgressRule["protocol"];
  readonly is_active?: boolean;
}
export interface EgressRequest {
  ...
  readonly matched_rule_id: UUID | null;
  readonly requested_at: string;
...
export interface SecretMetadata {
  ...
  readonly name: string;
  readonly description: string;
  readonly secret_type: "api_key" | "password" | "token" | "certificate" | "other";
  readonly is_active: boolean;
  readonly expires_at: string | null;
  readonly last_rotated_at: string;
  readonly rotation_interval_days: number | null;
  readonly created_at: string;
}
export interface SecretCreateRequest {
  readonly name: string;
  readonly description?: string;
  readonly secret_type: SecretMetadata["secret_type"];
...
export interface SecretAccess {
  readonly id: UUID;
  readonly secret_id: UUID;
  readonly secret_name?: string;
  readonly agent_execution_id: UUID | null;
  readonly accessed_by: UUID;
...
export interface QuotaUsage {
  ...
  readonly resource: string;
  readonly agent_execution_id: UUID | null;
  readonly usage_value: number;
  readonly remaining_after: number;
...
export interface CostSummary {
  ...
  readonly cost_by_type: JSONObject;
  readonly cost_by_module: JSONObject;
  readonly cost_by_provider: JSONObject;
}
export interface ShardSaturation {
  readonly id: UUID;
  readonly shard_id: string;
  readonly saturation_level: string;
  readonly active_agents: number;
  readonly active_executions: number;
  readonly cpu_usage_percent: string | null;
  readonly memory_usage_percent: string | null;
...
export interface KillSwitch {
  ...
  readonly scope_id: UUID | null;
  readonly status: KillSwitchStatus;
  readonly reason: string;
  readonly activated_by: UUID;
...
export interface AuditEvent {
  ...
  readonly tool_invocation_id: UUID | null;
  readonly approval_request_id: UUID | null;
  readonly initiating_principal: UUID;
  readonly subject_id: UUID;
  readonly session_id: UUID | null;
  ...
  readonly decisions: JSONObject;
  readonly transitions: JSONObject;
...
export interface AuditTrail {
  ...
  readonly completed_timestamp: string | null;
  readonly final_outcome: "success" | "failure" | "blocked" | "partial" | null;
...
export interface EvaluationResult {
  ...
  readonly suite_key: string;
  readonly tested_agent_version?: string;
...
export interface ModuleHealth {
  readonly status: "healthy" | "unavailable";
  readonly module: "ai_agent_management";
  readonly components: { readonly [name: string]: HealthComponent };
}
export interface CostRecalculationRequest {
  readonly period_start: string;
  readonly period_end: string;
  readonly period_type: CostSummary["period_type"];
  readonly currency: string;
  readonly idempotency_key: string;
}
...
export interface AgentManagementConfigurationDocument {
  ...
  readonly runner: {
    readonly allowed_task_fields: readonly string[];
  ...
  readonly agent: {
    ...
    readonly transition_key_maximum_length: number;
    readonly execution_idempotency_key_maximum_length: number;
    readonly search_maximum_length: number;
    readonly ordering_fields: readonly string[];
    readonly transition_reason_maximum_length: number;
    readonly error_code_maximum_length: number;
    readonly user_bound_requires_active_session: boolean;
    readonly only_active_agents_may_execute: boolean;
    readonly identity_session_rules: {
      readonly user_bound_requires_session: boolean;
      readonly system_bound_forbids_session: boolean;
    };
    readonly execution_state_transitions: { readonly [state: string]: readonly string[] };
  };
  readonly schedule: {
    readonly default_priority: number;
    readonly priority_minimum: number;
    readonly priority_maximum: number;
    readonly default_maximum_retries: number;
    readonly maximum_retries_limit: number;
    readonly dispatch_batch_minimum: number;
    readonly dispatch_batch_maximum: number;
  };
  readonly approval: {
    readonly require_for_non_read_only_tools: boolean;
    readonly requester_may_approve_own_request: boolean;
    readonly enforce_expiry: boolean;
    readonly rejection_requires_reason: boolean;
    readonly only_requester_may_cancel: boolean;
  };
  readonly separation_of_duties: {
    readonly actions_must_be_nonempty_and_different: boolean;
    readonly counterpart_detection_enabled: boolean;
  };
  readonly egress: {
    readonly forbidden_ip_addresses: readonly string[];
    readonly internal_hostname_suffixes: readonly string[];
    readonly allowed_url_schemes: readonly string[];
    readonly forbid_url_credentials: boolean;
    readonly forbid_url_query: boolean;
    readonly forbid_url_fragment: boolean;
  };
  readonly health: {
    readonly cache_probe_timeout_seconds: number;
    readonly minimum_rls_table_count: number;
    readonly outbox_stale_minutes: number;
  };
  readonly evaluation: {
    readonly quality_pass_threshold: number;
    readonly quality_warn_threshold: number;
    readonly hallucination_pass_threshold: number;
    readonly hallucination_warn_threshold: number;
    readonly max_token_fallback: number;
    readonly characters_per_estimated_token: number;
    readonly minimum_useful_output_length: number;
    readonly short_output_penalty: number;
    readonly efficiency_pass_threshold: number;
    readonly efficiency_warn_threshold: number;
    readonly latency_percentiles: readonly number[];
  };
  readonly secret: { readonly rotation_interval_minimum_days: number };
  readonly ui: {
    readonly agent_page_size: number;
    readonly execution_page_size: number;
    readonly execution_poll_interval_ms: number;
    readonly approval_page_size: number;
    readonly approval_poll_interval_ms: number;
    readonly schedule_page_size: number;
    readonly selection_page_size: number;
    readonly usage_page_size: number;
    readonly summary_page_size: number;
    readonly health_poll_interval_ms: number;
    readonly saturation_warning_threshold: number;
    readonly saturation_critical_threshold: number;
    ...
    readonly status_token_by_state: {
      readonly [state: string]: keyof AgentManagementConfigurationDocument["ui"]["status_tokens"];
    };
...
export interface AgentManagementConfigurationVersion {
  ...
  readonly correlation_id: UUID;
  readonly change_type: "bootstrap" | "update" | "import" | "rollback";
  readonly created_at: string;
}
export interface ConfigurationExportDocument {
  readonly schema: "saraise.ai-agent-management.configuration/v1";
  readonly environment: ConfigurationEnvironment;
  readonly version: number;
  readonly configuration: AgentManagementConfigurationDocument;
}
...
export interface AgentFilters extends PageRequest {
  readonly status?: AgentStatus;
  readonly identity_type?: IdentityType;
  readonly runner_key?: string;
  readonly subject_id?: UUID;
...
export interface ExecutionFilters extends PageRequest {
  readonly agent_id?: UUID;
  readonly state?: ExecutionState;
...
export interface ScheduleFilters extends PageRequest {
  ...
  readonly ordering?: "priority" | "-priority" | "scheduled_at" | "-scheduled_at";
}
export interface ApprovalFilters extends PageRequest {
  readonly status?: ApprovalStatus;
  readonly tool_id?: UUID;
  readonly execution_id?: UUID;
...
export interface ToolFilters extends PageRequest {
  readonly owning_module?: string;
  readonly side_effect_class?: SideEffectClass;
  readonly is_active?: boolean;
  readonly search?: string;
  readonly ordering?: "name" | "-name" | "registered_at" | "-registered_at";
}
export interface EvidenceFilters extends PageRequest {
  readonly execution_id?: UUID;
  readonly start?: string;
  readonly end?: string;
  readonly ordering?: string;
}
export interface AuditFilters extends EvidenceFilters {
  readonly correlation_id?: UUID;
  readonly event_type?: string;
  readonly outcome?: AuditOutcome;
}
...
export const ENDPOINTS = {
  AGENTS: {
    ...
    ACTIVATE: (id: UUID) => action("agents", id, "activate"),
    DISABLE: (id: UUID) => action("agents", id, "disable"),
    RETIRE: (id: UUID) => action("agents", id, "retire"),
    EXECUTE: (id: UUID) => action("agents", id, "execute"),
...
export const ROUTES = {
  AGENTS: "/ai-agents",
  AGENT_CREATE: "/ai-agents/create",
  AGENT_DETAIL: (id: UUID) => `/ai-agents/${id}` as const,
  AGENT_EDIT: (id: UUID) => `/ai-agents/${id}/edit` as const,
  EXECUTIONS: "/ai-agents/executions",
  EXECUTION_DETAIL: (id: UUID) => `/ai-agents/executions/${id}` as const,
  SCHEDULES: "/ai-agents/schedules",
  SCHEDULE_CREATE: "/ai-agents/schedules/create",
  SCHEDULE_DETAIL: (id: UUID) => `/ai-agents/schedules/${id}` as const,
  APPROVALS: "/ai-agents/approvals",
  APPROVAL_DETAIL: (id: UUID) => `/ai-agents/approvals/${id}` as const,
  TOOLS: "/ai-agents/tools",
  TOOL_CREATE: "/ai-agents/tools/create",
  TOOL_DETAIL: (id: UUID) => `/ai-agents/tools/${id}` as const,
  TOOL_EDIT: (id: UUID) => `/ai-agents/tools/${id}/edit` as const,
  CONFIGURATION: "/ai-agents/configuration",
  GOVERNANCE: "/ai-agents/governance",
  USAGE: "/ai-agents/usage",
  AUDIT: "/ai-agents/audit",
  AUDIT_TRAIL_DETAIL: (id: UUID) => `/ai-agents/audit/${id}` as const,
