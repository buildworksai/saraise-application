...
import { REGIONAL_QUERY_KEYS, ROUTES, type RegionalResourceUpdate } from "../contracts";
...
export const EditRegionalResourcePage = () => {
  ...
  const updateMutation = useMutation({
    mutationFn: (data: RegionalResourceUpdate) => regionalService.updateResource(id, data),
    onSuccess: (updated) => {
