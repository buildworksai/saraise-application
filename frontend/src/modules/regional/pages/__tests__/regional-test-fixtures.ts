...
export const resourceFixture = (overrides: Partial<RegionalResource> = {}): RegionalResource => ({
...
export const resourcePageFixture = (resources: RegionalResource[]): PaginatedRegionalResources => ({
