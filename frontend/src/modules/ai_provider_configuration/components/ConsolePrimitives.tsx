...
export function ConsoleHeader({
  ...
  return (
    <header className="border-b bg-gradient-to-br from-primary/10 via-background to-background px-4 py-7 sm:px-6 lg:px-8">
      ...
      <nav
        className="mx-auto mt-7 flex max-w-7xl gap-1 overflow-x-auto"
      ...
      >
        <NavLink
          ...
          className={({ isActive }) =>
            `whitespace-nowrap rounded-md px-3 py-2 text-sm font-medium ${isActive ? "bg-background text-foreground shadow-sm" : "text-muted-foreground hover:bg-background/60 hover:text-foreground"}`
          }
        >
          Provider console
        </NavLink>
        ...
        <NavLink
          ...
          className={({ isActive }) =>
            `flex items-center gap-2 whitespace-nowrap rounded-md px-3 py-2 text-sm font-medium ${isActive ? "bg-background text-foreground shadow-sm" : "text-muted-foreground hover:bg-background/60 hover:text-foreground"}`
          }
        >
...
export function ApiProblem({ error, onRetry }: { error: unknown; onRetry: () => void }) {
  ...
  return (
    <Card
      className="mx-auto flex min-h-72 max-w-3xl flex-col items-center justify-center p-8 text-center"
      role="alert"
    >
