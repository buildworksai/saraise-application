/**
 * AiProviderConfigurationListPage Component Tests
 */
...
describe('AiProviderConfigurationListPage', () => {
  ...
  it('should render loading state', () => {
    vi.mocked(ai_provider_configurationService.listResources).mockImplementation(
  ...
  it('should render empty state when no resources', async () => {
    vi.mocked(ai_provider_configurationService.listResources).mockResolvedValue([]);
  ...
  it('should render resources list', async () => {
    ...
    vi.mocked(ai_provider_configurationService.listResources).mockResolvedValue(mockResources as any);
