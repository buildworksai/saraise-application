/**
 * CreateAiProviderConfigurationResourcePage Component Tests
 */
...
describe('CreateAiProviderConfigurationResourcePage', () => {
  ...
  it('should submit form with valid data', async () => {
    const mockCreate = vi.mocked(ai_provider_configurationService.createResource).mockResolvedValue({ id: 'new-id' } as any);
