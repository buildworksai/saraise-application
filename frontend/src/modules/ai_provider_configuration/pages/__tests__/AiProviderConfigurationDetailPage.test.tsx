...
describe("AiProviderConfigurationDetailPage", () => {
  beforeEach(() => {
    vi.clearAllMocks();
    vi.mocked(aiProviderConfigurationService.getProvider).mockResolvedValue({
      id: "provider-1",
      name: "Mistral",
    ...
    vi.mocked(aiProviderConfigurationService.listModels).mockResolvedValue([
      {
        id: "model-1",
        provider: "provider-1",
