/**
 * BlockchainTraceabilityListPage Component Tests
 */
...
import { BlockchainTraceabilityListPage } from './BlockchainTraceabilityListPage';
...
describe('BlockchainTraceabilityListPage', () => {
  ...
  it('should render loading state', () => {
    vi.mocked(blockchain_traceability_service.listResources).mockImplementation(
  ...
  it('should render empty state when no resources', async () => {
    vi.mocked(blockchain_traceability_service.listResources).mockResolvedValue([]);
  ...
  it('should render resources list', async () => {
    ...
    vi.mocked(blockchain_traceability_service.listResources).mockResolvedValue(mockResources as any);
