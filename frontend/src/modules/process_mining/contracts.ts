...
/** ProcessMining resource entity */
export type ProcessMiningResource = {
  id: string;
  tenant_id: string;
  name: string;
  description?: string;
...
/** ProcessMining resource create request */
export type ProcessMiningResourceCreate = {
  name: string;
  description?: string;
  is_active?: boolean;
  config?: Record<string, unknown>;
...
/** ProcessMining resource update request (partial) */
export type ProcessMiningResourceUpdate = Partial<ProcessMiningResourceCreate>;
...
/**
 * ProcessMining API Endpoints
 * * All endpoints should be prefixed with /api/v1/process-mining/
 */
export const MODULE_API_PREFIX = '/api/v1/process-mining';
