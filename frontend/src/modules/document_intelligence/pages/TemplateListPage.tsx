...
export function TemplateListPage() {
  ...
  const query = useQuery({ queryKey: ['document-intelligence', 'templates', page, status, category], queryFn: () => documentIntelligenceService.listTemplates({ page, page_size: 25, status, document_category: category, ordering: 'name' }) });
