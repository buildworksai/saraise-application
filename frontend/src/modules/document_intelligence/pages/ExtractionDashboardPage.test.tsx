...
import { documentIntelligenceConfiguration } from "./test-fixtures";
...
const result: PaginatedResult<DocumentExtractionListItem> = {
  items: [extraction],
  pagination: {
    count: 1,
    page: 1,
...
function renderDashboard() {
  ...
  return render(
    <QueryClientProvider client={client}>
      <MemoryRouter initialEntries={["/document-intelligence/extractions?status=queued"]}>
        <ExtractionDashboardPage />
      </MemoryRouter>
    </QueryClientProvider>
  );
}
