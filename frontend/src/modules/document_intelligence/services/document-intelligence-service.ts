...
function addPageFilters(
  ...
  filters: { page?: number; page_size?: number; search?: string; ordering?: string }
): void {
...
export const documentIntelligenceService = {
  listExtractions: (filters: ExtractionFilters = {}) =>
    getPage(() =>
      apiClient.get<ApiV2PaginatedEnvelope<DocumentExtractionListItem>>(extractionQuery(filters))
    ),
  createExtraction: (request: DocumentExtractionCreateRequest) =>
    getData(() =>
      apiClient.post<ApiV2Envelope<AcceptedExtraction>>(ENDPOINTS.EXTRACTIONS.CREATE, request)
    ),
  getExtraction: (id: UUID) =>
    getData(() =>
      apiClient.get<ApiV2Envelope<DocumentExtraction>>(ENDPOINTS.EXTRACTIONS.DETAIL(id))
    ),
  archiveExtraction: (id: UUID) =>
    call(() => apiClient.delete<void>(ENDPOINTS.EXTRACTIONS.DETAIL(id))),
  listExtractionPages: (id: UUID) =>
    getPage(() =>
      apiClient.get<ApiV2PaginatedEnvelope<DocumentExtractionPage>>(ENDPOINTS.EXTRACTIONS.PAGES(id))
    ),
  getExtractionPage: (id: UUID) =>
    getData(() =>
      apiClient.get<ApiV2Envelope<DocumentExtractionPage>>(ENDPOINTS.EXTRACTION_PAGES.DETAIL(id))
    ),
  retryExtraction: (id: UUID, request: RetryRequest) =>
    getData(() =>
      apiClient.post<ApiV2Envelope<AcceptedExtraction>>(ENDPOINTS.EXTRACTIONS.RETRY(id), request)
    ),
  cancelExtraction: (id: UUID, request: CancelRequest) =>
    getData(() =>
      apiClient.post<ApiV2Envelope<DocumentExtraction>>(ENDPOINTS.EXTRACTIONS.CANCEL(id), request)
    ),

  listClassifications: (filters: ClassificationFilters = {}) =>
    getPage(() =>
      apiClient.get<ApiV2PaginatedEnvelope<DocumentClassificationListItem>>(
        classificationQuery(filters)
      )
    ),
  createClassification: (request: DocumentClassificationCreateRequest) =>
    getData(() =>
      apiClient.post<ApiV2Envelope<AcceptedClassification>>(
        ENDPOINTS.CLASSIFICATIONS.CREATE,
        request
      )
    ),
  getClassification: (id: UUID) =>
    getData(() =>
      apiClient.get<ApiV2Envelope<DocumentClassification>>(ENDPOINTS.CLASSIFICATIONS.DETAIL(id))
    ),
  archiveClassification: (id: UUID) =>
    call(() => apiClient.delete<void>(ENDPOINTS.CLASSIFICATIONS.DETAIL(id))),
  listClassificationScores: (id: UUID) =>
    getPage(() =>
      apiClient.get<ApiV2PaginatedEnvelope<DocumentClassificationScore>>(
        ENDPOINTS.CLASSIFICATIONS.SCORES(id)
      )
    ),
  getClassificationScore: (id: UUID) =>
    getData(() =>
      apiClient.get<ApiV2Envelope<DocumentClassificationScore>>(
        ENDPOINTS.CLASSIFICATION_SCORES.DETAIL(id)
      )
    ),
  reviewClassification: (id: UUID, request: ClassificationReviewRequest) =>
    getData(() =>
      apiClient.post<ApiV2Envelope<DocumentClassification>>(
        ENDPOINTS.CLASSIFICATIONS.REVIEW(id),
        request
      )
    ),
  retryClassification: (id: UUID, request: RetryRequest) =>
    getData(() =>
      apiClient.post<ApiV2Envelope<AcceptedClassification>>(
        ENDPOINTS.CLASSIFICATIONS.RETRY(id),
        request
      )
    ),
  cancelClassification: (id: UUID, request: CancelRequest) =>
    getData(() =>
      apiClient.post<ApiV2Envelope<DocumentClassification>>(
        ENDPOINTS.CLASSIFICATIONS.CANCEL(id),
        request
      )
    ),
  ...
  listTemplates: (filters: TemplateFilters = {}) =>
    getPage(() =>
      apiClient.get<ApiV2PaginatedEnvelope<ExtractionTemplateListItem>>(templateQuery(filters))
    ),
  createTemplate: (request: ExtractionTemplateCreateRequest) =>
    getData(() =>
      apiClient.post<ApiV2Envelope<ExtractionTemplate>>(ENDPOINTS.TEMPLATES.CREATE, request)
    ),
  getTemplate: (id: UUID) =>
  ...
  updateTemplate: (id: UUID, request: ExtractionTemplateUpdateRequest) =>
    getData(() =>
      apiClient.patch<ApiV2Envelope<ExtractionTemplate>>(ENDPOINTS.TEMPLATES.DETAIL(id), request)
    ),
  ...
  activateTemplate: (id: UUID, request: TransitionRequest) =>
    getData(() =>
      apiClient.post<ApiV2Envelope<ExtractionTemplate>>(ENDPOINTS.TEMPLATES.ACTIVATE(id), request)
    ),
  deactivateTemplate: (id: UUID, request: TransitionRequest) =>
    getData(() =>
      apiClient.post<ApiV2Envelope<ExtractionTemplate>>(ENDPOINTS.TEMPLATES.DEACTIVATE(id), request)
    ),
  cloneTemplate: (id: UUID, request: CloneTemplateRequest) =>
    getData(() =>
      apiClient.post<ApiV2Envelope<ExtractionTemplate>>(ENDPOINTS.TEMPLATES.CLONE(id), request)
    ),
  matchTemplate: (id: UUID, request: TemplateMatchRequest) =>
    getData(() =>
      apiClient.post<ApiV2Envelope<TemplateMatchResult>>(ENDPOINTS.TEMPLATES.MATCH(id), request)
    ),
  listTemplateZones: (templateId: UUID, pageSize: number) => {
    ...
    return getPage(() =>
      apiClient.get<ApiV2PaginatedEnvelope<ExtractionTemplateZone>>(
        withQuery(ENDPOINTS.TEMPLATE_ZONES.LIST, params)
      )
    );
  },
  createTemplateZone: (request: ExtractionTemplateZoneCreateRequest) =>
    getData(() =>
      apiClient.post<ApiV2Envelope<ExtractionTemplateZone>>(
        ENDPOINTS.TEMPLATE_ZONES.CREATE,
        request
      )
    ),
  getTemplateZone: (id: UUID) =>
    getData(() =>
      apiClient.get<ApiV2Envelope<ExtractionTemplateZone>>(ENDPOINTS.TEMPLATE_ZONES.DETAIL(id))
    ),
  updateTemplateZone: (id: UUID, request: ExtractionTemplateZoneUpdateRequest) =>
    getData(() =>
      apiClient.patch<ApiV2Envelope<ExtractionTemplateZone>>(
        ENDPOINTS.TEMPLATE_ZONES.DETAIL(id),
        request
      )
    ),
  deleteTemplateZone: (id: UUID) =>
    call(() => apiClient.delete<void>(ENDPOINTS.TEMPLATE_ZONES.DETAIL(id))),

  listTrainingJobs: (filters: TrainingJobFilters = {}) =>
    getPage(() =>
      apiClient.get<ApiV2PaginatedEnvelope<ClassifierTrainingJobListItem>>(trainingQuery(filters))
    ),
  createTrainingJob: (request: ClassifierTrainingJobCreateRequest) =>
    getData(() =>
      apiClient.post<ApiV2Envelope<AcceptedTrainingJob>>(ENDPOINTS.TRAINING_JOBS.CREATE, request)
    ),
  getTrainingJob: (id: UUID) =>
    getData(() =>
      apiClient.get<ApiV2Envelope<ClassifierTrainingJobDetail>>(ENDPOINTS.TRAINING_JOBS.DETAIL(id))
    ),
  retryTrainingJob: (id: UUID, request: RetryRequest) =>
    getData(() =>
      apiClient.post<ApiV2Envelope<AcceptedTrainingJob>>(ENDPOINTS.TRAINING_JOBS.RETRY(id), request)
    ),
  cancelTrainingJob: (id: UUID, request: CancelRequest) =>
    getData(() =>
      apiClient.post<ApiV2Envelope<ClassifierTrainingJobDetail>>(
        ENDPOINTS.TRAINING_JOBS.CANCEL(id),
        request
      )
    ),
  ...
  listModelVersions: (filters: ModelVersionFilters = {}) =>
    getPage(() =>
      apiClient.get<ApiV2PaginatedEnvelope<ClassifierModelVersionListItem>>(modelQuery(filters))
    ),
  getModelVersion: (id: UUID) =>
    getData(() =>
      apiClient.get<ApiV2Envelope<ClassifierModelVersion>>(ENDPOINTS.MODEL_VERSIONS.DETAIL(id))
    ),
  activateModelVersion: (id: UUID, request: TransitionRequest) =>
    getData(() =>
      apiClient.post<ApiV2Envelope<ClassifierModelVersion>>(
        ENDPOINTS.MODEL_VERSIONS.ACTIVATE(id),
        request
      )
    ),
  rollbackModelVersion: (id: UUID, request: TransitionRequest) =>
    getData(() =>
      apiClient.post<ApiV2Envelope<ClassifierModelVersion>>(
        ENDPOINTS.MODEL_VERSIONS.ROLLBACK(id),
        request
      )
    ),
  ...
  getConfiguration: () =>
    getData(() =>
      apiClient.get<ApiV2Envelope<DocumentIntelligenceConfiguration>>(
        ENDPOINTS.CONFIGURATION.CURRENT
      )
    ),
  updateConfiguration: (request: ConfigurationWriteRequest) =>
    getData(() =>
      apiClient.put<ApiV2Envelope<DocumentIntelligenceConfiguration>>(
        ENDPOINTS.CONFIGURATION.CURRENT,
        request
      )
    ),
  listConfigurationVersions: () =>
    getData(() =>
      apiClient.get<ApiV2Envelope<readonly ConfigurationVersion[]>>(
  ...
  simulateConfiguration: (request: ConfigurationSimulationRequest) =>
    getData(() =>
      apiClient.post<ApiV2Envelope<ConfigurationSimulation>>(
        ENDPOINTS.CONFIGURATION.SIMULATE,
        request
      )
    ),
  rollbackConfiguration: (request: ConfigurationRollbackRequest) =>
    getData(() =>
      apiClient.post<ApiV2Envelope<DocumentIntelligenceConfiguration>>(
  ...
  exportConfiguration: () =>
    getData(() =>
      apiClient.get<ApiV2Envelope<ConfigurationExportDocument>>(ENDPOINTS.CONFIGURATION.EXPORT)
    ),
