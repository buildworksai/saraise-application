/**
 * Create Asset Page - Asset Management
 */
...
import type { AssetCreate } from '../contracts';
...
export const CreateAssetPage = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (
      ...
      toast.error('Code, name, purchase date, cost, value, and depreciation method are required');
      return;
    }
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <Select
                value={form.category}
                onValueChange={(v) => setForm({ ...form, category: v as AssetCreate['category'] })}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
