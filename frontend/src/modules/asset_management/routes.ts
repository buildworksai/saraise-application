...
export const tenantRoutes = [
  {
    ...
    Page: lazy(() =>
      import("./pages/AssetListPage").then(({ AssetListPage }) => ({ default: AssetListPage }))
    ),
  ...
  },
  {
    ...
    Page: lazy(() =>
      import("./pages/CreateAssetPage").then(({ CreateAssetPage }) => ({
        default: CreateAssetPage,
      }))
    ),
    title: "Create asset",
  ...
  },
  {
    ...
    Page: lazy(() =>
      import("./pages/AssetDetailPage").then(({ AssetDetailPage }) => ({
  ...
  },
  {
    ...
    Page: lazy(() =>
      import("./pages/EditAssetPage").then(({ EditAssetPage }) => ({ default: EditAssetPage }))
    ),
    title: "Edit asset",
  ...
  },
  {
    ...
    Page: lazy(() =>
      import("./pages/AssetConfigurationPage").then(({ AssetConfigurationPage }) => ({
        default: AssetConfigurationPage,
      }))
    ),
