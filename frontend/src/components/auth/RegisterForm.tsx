...
export function RegisterForm() {
  ...
  const validateAllFields = () => {
    ...
    const validatorKeys: (keyof typeof validators)[] = ['name', 'email', 'password', 'confirmPassword']
      ...
      <div className="h-screen flex overflow-hidden">
        ...
        <div className="hidden lg:flex lg:w-1/2 bg-[#040818] flex-col justify-center relative overflow-hidden h-full">
          ...
          <div className="relative z-10 text-center px-8 lg:px-12">
            ...
            <h2 className="text-2xl lg:text-3xl font-bold text-white mb-3 lg:mb-4">Welcome to SARAISE!</h2>
            <p className="text-white/90 text-base lg:text-lg">Your account has been created successfully</p>
          </div>
        </div>
          ...
          <div className="space-y-8 text-white max-w-xl">
            ...
            <div className="space-y-3">
              ...
              <p className="text-white/80">
                Activate no-code workflows, multi-tenant governance, and enterprise automation from a single control plane.
              </p>
            </div>
          ...
          <Card className="shadow-xl border-0">
            <CardHeader className="space-y-4 pb-6">
              ...
              <div className="space-y-2 text-center lg:text-left">
                ...
                <CardDescription className="text-base">
                  Start your journey with SARAISE
                </CardDescription>
              </div>
            </CardHeader>
          <CardContent>
            ...
            >
              <div className="space-y-2">
                ...
                {fieldErrors.name && (
                  <p id="register-name-error" className="text-xs text-red-600 dark:text-red-400" role="alert">
                    {fieldErrors.name}
                  </p>
                )}
              </div>
              ...
              <div className="space-y-2">
                ...
                {fieldErrors.email && (
                  <p id="register-email-error" className="text-xs text-red-600 dark:text-red-400" role="alert">
                    {fieldErrors.email}
                  </p>
                )}
              </div>
