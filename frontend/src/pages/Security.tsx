        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          ...
          <section className="mb-12">
            ...
            <p className="text-muted-foreground leading-relaxed">
              BuildFlow Consultancy Private Limited is committed to maintaining the security and
              integrity of SARAISE. We implement industry-standard security practices and
              continuously improve our security posture to protect our users and their data.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <h3 className="text-xl font-semibold mb-3 mt-6">3.2 Infrastructure Security</h3>
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground mb-4">
            ...
            <h3 className="text-xl font-semibold mb-3 mt-6">3.3 Data Protection</h3>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold mb-4">4. Authentication and Access Control</h2>
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
              <li>
                <strong>Session-Based Authentication:</strong> Secure HTTP-only cookies with Redis
                session storage
              </li>
              <li>
                <strong>Role-Based Access Control (RBAC):</strong> Granular permissions for platform
                and tenant roles
              </li>
              <li>
                <strong>Multi-Factor Authentication (MFA):</strong> TOTP-based step-up
                authentication for sensitive operations
              </li>
              <li>
                <strong>Single Sign-On (SSO):</strong> SAML/OIDC integration with Azure AD, Google
                Workspace, Okta
              </li>
              <li>
                <strong>Audit Logging:</strong> Immutable audit trails for all sensitive operations
              </li>
            </ul>
          </section>

          <section className="mb-12">
            <h2 className="text-2xl font-bold mb-4">5. Vulnerability Disclosure</h2>
            <h3 className="text-xl font-semibold mb-3">5.1 Responsible Disclosure</h3>
            ...
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground mb-4">
              ...
              <li>Provide detailed information about the vulnerability and potential impact</li>
              <li>Allow us reasonable time to fix the issue before disclosure</li>
            </ul>

            <h3 className="text-xl font-semibold mb-3 mt-6">5.2 Response Timeline</h3>
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
              <li>
                <strong>Initial Response:</strong> Within 48 hours of report receipt
              </li>
              <li>
                <strong>Assessment:</strong> Within 7 days to confirm and assess severity
              </li>
              <li>
                <strong>Fix Timeline:</strong> Based on severity (Critical: 7 days, High: 30 days,
                Medium: 90 days)
              </li>
              <li>
          ...
          <section className="mb-12">
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              We regularly release security updates to address vulnerabilities and improve security.
              We recommend:
            </p>
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
              <li>Subscribing to security advisories on GitHub</li>
              <li>Keeping your SARAISE installation up to date</li>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold mb-4">7. Compliance and Certifications</h2>
            <p className="text-muted-foreground leading-relaxed mb-4">
              SARAISE is designed with compliance in mind:
            </p>
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
              <li>
                <strong>SOC 2 Aligned:</strong> Security controls aligned with SOC 2 Type II
                framework
              </li>
              <li>
                <strong>GDPR Compliant:</strong> Data protection measures aligned with GDPR
                requirements
              </li>
              <li>
                <strong>ISO 27001 Principles:</strong> Information security management best
                practices
              </li>
              <li>
                <strong>OWASP Top 10:</strong> Protection against common web application
                vulnerabilities
              </li>
            </ul>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              When self-hosting SARAISE, you are responsible for:
            </p>
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
            ...
            <p className="text-muted-foreground leading-relaxed mt-4">
              We provide security best practices documentation, but ultimate responsibility for
              security in self-hosted instances lies with you.
            </p>
          </section>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold mb-4">10. Security Best Practices for Users</h2>
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold mb-4">11. Contact Security Team</h2>
            <p className="text-muted-foreground leading-relaxed mb-4">
