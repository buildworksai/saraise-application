        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          ...
          <section className="mb-12">
            ...
            <p className="text-muted-foreground leading-relaxed">
              By accessing or using SARAISE website, software, documentation, or services provided
              by BuildFlow Consultancy Private Limited ("we," "our," or "us"), you agree to be bound
          ...
          <section className="mb-12">
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              SARAISE is an open-source ERP software platform licensed under Apache 2.0. We provide:
            </p>
          ...
          <section className="mb-12">
            ...
            <h3 className="text-xl font-semibold mb-3">3.1 Apache 2.0 License</h3>
            <p className="text-muted-foreground leading-relaxed mb-4">
              SARAISE software is licensed under the Apache License, Version 2.0 (the "License").
              You may not use this software except in compliance with the License. A copy of the
          ...
          <section className="mb-12">
            ...
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
              ...
              <li>
                Use SARAISE to compete with our commercial offerings in a manner that violates these
                Terms
              </li>
            </ul>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              The SARAISE name, logo, trademarks, and website content (excluding open-source code)
              are the property of BuildFlow Consultancy Private Limited. You may not use our
              trademarks without prior written permission.
            </p>

            <h3 className="text-xl font-semibold mb-3 mt-6">5.2 Your Contributions</h3>
            <p className="text-muted-foreground leading-relaxed mb-4">
              By contributing code, documentation, or other materials to SARAISE, you grant us a
              perpetual, worldwide, non-exclusive, royalty-free license to use, modify, distribute,
              and sublicense your contributions under the Apache 2.0 License.
            </p>
          </section>

          <section className="mb-12">
            <h2 className="text-2xl font-bold mb-4">6. Self-Hosted Instances</h2>
            <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            <p className="text-muted-foreground leading-relaxed mt-4">
              We are not liable for any issues, data loss, or security breaches in self-hosted
              instances.
            </p>
          </section>

          <section className="mb-12">
            <h2 className="text-2xl font-bold mb-4">7. Cloud Hosting Services</h2>
            <p className="text-muted-foreground leading-relaxed mb-4">
              If you use our cloud hosting services (when available), additional terms will apply,
              including:
            </p>
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
            ...
            <p className="text-muted-foreground leading-relaxed mt-4">
              Cloud hosting services are subject to separate terms and conditions that will be
          ...
          <section className="mb-12">
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              SARAISE IS PROVIDED "AS IS" AND "AS AVAILABLE" WITHOUT WARRANTIES OF ANY KIND, EITHER
              EXPRESS OR IMPLIED, INCLUDING BUT NOT LIMITED TO WARRANTIES OF MERCHANTABILITY,
              FITNESS FOR A PARTICULAR PURPOSE, OR NON-INFRINGEMENT.
            </p>

            <h3 className="text-xl font-semibold mb-3 mt-6">8.2 No Guarantee</h3>
            <p className="text-muted-foreground leading-relaxed">
              We do not guarantee that SARAISE will be error-free, secure, or available at all
              times. We reserve the right to modify, suspend, or discontinue any part of our
          ...
          <section className="mb-12">
            ...
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
              ...
              <li>
                Damages resulting from unauthorized access or data breaches in self-hosted instances
              </li>
            </ul>
            <p className="text-muted-foreground leading-relaxed mt-4">
          ...
          <section className="mb-12">
            ...
            <p className="text-muted-foreground leading-relaxed">
              You agree to indemnify, defend, and hold harmless BuildFlow Consultancy Private
              Limited and its officers, directors, employees, and agents from any claims, damages,
              losses, liabilities, and expenses (including legal fees) arising from your use of
              SARAISE, violation of these Terms, or infringement of any rights of another party.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              that by their nature should survive termination (including disclaimers, limitations of
